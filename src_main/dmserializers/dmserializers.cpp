...
#define DECLARE_FORMAT_UPDATER(_name, _description, _extension, _version, \
                               _encoding)                                 \
  class CDmFormatUpdater_##_name : public IDmFormatUpdater {              \
   public:                                                                \
    ...
    virtual bool Update(CDmElement **pRoot, int nSourceVersion) {         \
      return true;                                                        \
    }                                                                     \
  };                                                                      \
...
DECLARE_FORMAT_UPDATER(facial_animation, "Facial Animation File", "dmx", 1,
                       "binary")
DECLARE_FORMAT_UPDATER(model, "DMX Model", "dmx", 1, "binary")
// DECLARE_FORMAT_UPDATER( animation,			"DMX Animation",
// "dmx", 1, "binary" )
// DECLARE_FORMAT_UPDATER( dcc_makefile,			"DMX Makefile",
// "dmx", 1, "keyvalues2" )
