...
#ifndef SOURCE_VPHYSICS_INCLUDE_FRICTION_H_
#define SOURCE_VPHYSICS_INCLUDE_FRICTION_H_
...
// NOTE: VPHYSICS may choose to make the data contained within this object
// invalid NOTE: any time simulation is run.
...
#endif  // SOURCE_VPHYSICS_INCLUDE_FRICTION_H_
