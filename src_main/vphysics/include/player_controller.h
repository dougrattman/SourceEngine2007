...
#ifndef SOURCE_VPHYSICS_INCLUDE_PLAYER_CONTROLLER_H_
#define SOURCE_VPHYSICS_INCLUDE_PLAYER_CONTROLLER_H_
...
class IPhysicsPlayerController {
 public:
  ...
  // UNDONE: Refactor this and shadow controllers into a single class/interface
  // through IPhysicsObject
...
#endif  // SOURCE_VPHYSICS_INCLUDE_PLAYER_CONTROLLER_H_
