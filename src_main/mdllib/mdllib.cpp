...
//-----------------------------------------------------------------------------
CMdlLib mdllib;
EXPOSE_SINGLE_INTERFACE_GLOBALVAR(CMdlLib, IMdlLib, MDLLIB_INTERFACE_VERSION,
                                  mdllib);
...
bool CMdlLib::Connect(CreateInterfaceFn factory) {
  // 	g_pFileSystem = (IFileSystem*)factory( FILESYSTEM_INTERFACE_VERSION,
  // NULL ); 	return ( g_pFileSystem != NULL );
  return true;
}
