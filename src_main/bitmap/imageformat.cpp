...
static ImageFormatInfo_t g_ImageFormatInfo[] = {
    ...
    {"RGB888_BLUESCREEN", 3, 8, 8, 8, 0,
     false},  // IMAGE_FORMAT_RGB888_BLUESCREEN
    {"BGR888_BLUESCREEN", 3, 8, 8, 8, 0,
     false},                             // IMAGE_FORMAT_BGR888_BLUESCREEN
    ...
    {"IMAGE_FORMAT_RGB323232F", 12, 32, 32, 32, 0,
     false},  // IMAGE_FORMAT_RGB323232F
    {"IMAGE_FORMAT_RGBA32323232F", 16, 32, 32, 32, 32,
     false},  // IMAGE_FORMAT_RGBA32323232F
    ...
    // Vendor-dependent compressed formats typically used for normal map
    // compression
...
int GetMipMapLevelByteOffset(int width, int height, ImageFormat imageFormat,
                             int skipMipLevels) {
  int offset = 0;
...
ImageFormat D3DFormatToImageFormat(D3DFORMAT format) {
  switch (format) {
    ...
    case D3DFMT_A32B32G32R32F:
      ...
      // DST and FOURCC formats mapped back to ImageFormat (for
      // vendor-dependent shadow depth textures)
...
D3DFORMAT ImageFormatToD3DFormat(ImageFormat format) {
  ...
  switch (format) {
    ...
    // ImageFormat mapped to vendor-dependent FOURCC formats (for shadow depth
    // textures)
