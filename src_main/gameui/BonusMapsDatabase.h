...
class CBonusMapsDatabase {
 public:
  ...
  void SetCurrentChallengeNames(const char *pchFileName, const char *pchMapName,
                                const char *pchChallengeName);
  void GetCurrentChallengeNames(char *pchFileName, size_t file_name_size,
  ...
  bool SetBooleanStatus(const char *pchName, const char *pchFileName,
                        const char *pchMapName, bool bValue);
  bool SetBooleanStatus(const char *pchName, int iIndex, bool bValue);
  bool UpdateChallengeBest(const char *pchFileName, const char *pchMapName,
 ...
 private:
  void AddBonus(const char *pCurrentPath, const char *pDirFileName,
                bool bIsFolder);
  ...
  void ParseBonusMapData(char const *pszFileName, char const *pszShortName,
                         bool bIsFolder);
