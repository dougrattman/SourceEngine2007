...
class CGameUI : public IGameUI {
 public:
  ...
  virtual void BonusMapComplete(const char *pchFileName = NULL,
                                const char *pchMapName = NULL);
  virtual void BonusMapChallengeUpdate(const char *pchFileName,
  ...
  virtual void OLD_OnConnectToServer(const char *game, int IP,
 ...
 private:
  ...
  virtual void StopProgressBar(bool bError, const char *failureReason,
                               const char *extendedReason = NULL);
