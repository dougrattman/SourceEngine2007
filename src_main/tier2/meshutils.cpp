...
void GenerateQuadIndexBuffer(unsigned short* pIndices, int nIndexCount,
                             int nFirstVertex) {
  if (!pIndices) return;
...
void GeneratePolygonIndexBuffer(unsigned short* pIndices, int nIndexCount,
                                int nFirstVertex) {
  if (!pIndices) return;
...
void GenerateLineStripIndexBuffer(unsigned short* pIndices, int nIndexCount,
                                  int nFirstVertex) {
  if (!pIndices) return;
...
void GenerateLineLoopIndexBuffer(unsigned short* pIndices, int nIndexCount,
                                 int nFirstVertex) {
  if (!pIndices) {
    return;
  }
