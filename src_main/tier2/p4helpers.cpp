...
CP4File::CP4File(char const *szFilename) : m_sFilename(szFilename) {}

CP4File::~CP4File() {}

bool CP4File::Edit(void) { return p4->OpenFileForEdit(m_sFilename.String()); }

bool CP4File::Add(void) { return p4->OpenFileForAdd(m_sFilename.String()); }
...
extern CP4Factory *g_p4factory =
    &s_static_p4_factory;  // NULL before the factory constructs
