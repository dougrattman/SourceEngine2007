...
void old_bf_write::WriteBitCoordMP(const float f, bool bIntegral,
                                   bool bLowPrecision) {
#if defined(BB_PROFILING)
...
const uint8_t g_BitMask[8] = {0x1, 0x2, 0x4, 0x8, 0x10, 0x20, 0x40, 0x80};
const uint8_t g_TrailingMask[8] = {0xff, 0xfe, 0xfc, 0xf8,
                                   0xf0, 0xe0, 0xc0, 0x80};
...
int old_bf_read::ReadByte() { return ReadUBitLong(sizeof(unsigned char) << 3); }

int old_bf_read::ReadShort() { return ReadSBitLong(sizeof(short) << 3); }
