...
//-----------------------------------------------------------------------------
// Recursively adds all elements referred to this element into the list of
// elements
//-----------------------------------------------------------------------------
void AddElementsRecursively_R(CDmElement *pElement, ElementChoiceList_t &list,
                              ElementDict_t &dict, const char *pElementType) {
  if (!pElement) return;

  if (dict.Find(pElement) != dict.InvalidIndex()) return;
...
// elements
//-----------------------------------------------------------------------------
void AddElementsRecursively_R(CDmElement *pElement, DmeHandleVec_t &list,
                              ElementDict_t &dict, const char *pElementType) {
  if (!pElement) return;
...
// elements
//-----------------------------------------------------------------------------
void AddElementsRecursively(CDmElement *obj, ElementChoiceList_t &list,
