...
#ifndef SOURCE_TOOLS_VMT_VMTDOC_H_
#define SOURCE_TOOLS_VMT_VMTDOC_H_
...
class CVMTDoc : public IDmNotify {
 ...
 private:
  ...
  CDmAttribute *AddAttributeForShaderParameter(CDmElement *pMaterial,
                                               const char *pParamName,
                                               ShaderParamType_t paramType);

  // Add a single shader parameter if it doesn't exist
  void AddNewShaderParam(CDmElement *pMaterial, const char *pParamName,
                         ShaderParamType_t paramType, const char *pValue);
  ...
  void RemoveUnusedShaderParams(CDmElement *pMaterial, IShader *pShader,
                                IShader *pOldShader);
  ...
  void SetAttributeValueFromDefault(CDmElement *pMaterial,
...
#endif  // SOURCE_TOOLS_VMT_VMTDOC_H_
