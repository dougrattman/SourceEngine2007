...
public:
	...
	void	CopyString( difftype_t dt, char *outstring, const char *instring ); // Copy a 0-terminated string
...
private:
	...
	difftype_t	CompareString( char *outstring, const char *instring ); // Compare a 0-terminated string
	...
	void	DescribeString( difftype_t dt, char *outstring, const char *instring ); // Compare a 0-terminated string
	...
	void	WatchString( difftype_t dt, char *outstring, const char *instring ); // Compare a 0-terminated string
