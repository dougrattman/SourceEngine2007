...
public:
	...
	void WriteString( const char *pstring );                                    // Save a 0-terminated string
	void WriteString( const string_t *stringId, int count = 1 );	                       // Save a 0-terminated string (engine string)
	...
	void WriteString( const char *pname, const char *pstring );                // Save a 0-terminated string
	void WriteString( const char *pname, const string_t *stringId, int count = 1 );	   // Save a 0-terminated string (engine string)
...
public:
	...
	void ReadString( char *pDest, int nSizeDest, int nBytesAvailable ); // A 0-terminated string
