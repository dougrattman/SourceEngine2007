...
{
	Assert( i >= 0 && i < std::size( g_ClassInfos ) );
...
CUtlVectorInitialized< const char * > CTPlayerModels( CTPlayerModelStrings, std::size( CTPlayerModelStrings ) );
CUtlVectorInitialized< const char * > TerroristPlayerModels( TerroristPlayerModelStrings, std::size( TerroristPlayerModelStrings ) );
