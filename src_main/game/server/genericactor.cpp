...
// relationship table.
//=========================================================
Class_T CGenericActor::Classify(void) { return CLASS_NONE; }

//=========================================================
// MaxYawSpeed - allows each sequence to have a different
// turn rate associated with it.
//=========================================================
float CGenericActor::MaxYawSpeed(void) { return 90; }
...
//=========================================================
int CGenericActor::GetSoundInterests(void) { return NULL; }
...
void CGenericActor::Spawn() {
  ...
  */
  ...
  m_iHealth = 8;
  m_flFieldOfView = 0.5;  // indicates the width of this NPC's forward view cone
...
//=========================================================
void CGenericActor::Precache() { PrecacheModel(STRING(GetModelName())); }
...
class CFlextalkActor : public CGenericActor {
 ...
 public:
  ...
  // FCAP_IMPULSE_USE); } int OnTakeDamage( CBaseEntity *pInflictor, CBaseEntity
  // *pAttacker, float flDamage, int bitsDamageType ); void Spawn( void ); void
  // Precache( void ); void Think( void );
