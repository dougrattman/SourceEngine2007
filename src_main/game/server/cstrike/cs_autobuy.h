 ...
 * Has to be different that the previous ones because these are bitmasked values
 * as a weapon can be from more than one class.  This also includes all the
 * classes of equipment that a player can buy.
 */
...
struct RebuyStruct {
  ...
  int m_primaryAmmo;    // number of rounds the player had (not including rounds
                        // in the gun)
  int m_secondaryAmmo;  // number of rounds the player had (not including rounds
                        // in the gun)
