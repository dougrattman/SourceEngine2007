...
struct AI_MoveSuggestion_t {
  AI_MoveSuggestion_t();
  AI_MoveSuggestion_t(AI_MoveSuggType_t newType, float newWeight, float newDir,
  ...
  // The unadjusted weight of the suggestion [0..1], although [-1..1] within the
  // solver
  float weight;
...
class CAI_MoveSolver {
 public:
  ...
  // suggestions, after applying the regulations
  //---------------------------------
