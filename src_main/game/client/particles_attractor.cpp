...
//-----------------------------------------------------------------------------
CParticleAttractor *CParticleAttractor::Create(const Vector &center,
...
//			timeDelta -
//-----------------------------------------------------------------------------
void CParticleAttractor::UpdateVelocity(SimpleParticle *pParticle,
                                        float timeDelta) {
  ...
  speed = std::clamp((speed + speed * 0.2f), 0.0f, 1024.0f);
...
float CParticleAttractor::UpdateScale(const SimpleParticle *pParticle) {
  return (((float)pParticle->m_uchStartSize) *
