...
#define POD_VIEW_FOV 90.0f
#define POD_VIEW_YAW_MIN -60.0f
#define POD_VIEW_YAW_MAX 60.0f
#define POD_VIEW_PITCH_MIN -90.0f
#define POD_VIEW_PITCH_MAX \
  38.0f  // Don't let players look down and see that the pod is empty
...
IMPLEMENT_CLIENTCLASS_DT(C_PropVehiclePrisonerPod, DT_PropVehiclePrisonerPod,
...
//-----------------------------------------------------------------------------
int C_PropVehiclePrisonerPod::GetPassengerRole(
...
//-----------------------------------------------------------------------------
void C_PropVehiclePrisonerPod::GetVehicleViewPosition(int nRole,
                                                      Vector *pAbsOrigin,
                                                      QAngle *pAbsAngles,
                                                      float *pFOV /*=NULL*/) {
...
//			pCmd -
//-----------------------------------------------------------------------------
void C_PropVehiclePrisonerPod::UpdateViewAngles(C_BasePlayer *pLocalPlayer,
                                                CUserCmd *pCmd) {
  ...
  flAngleDiff = std::clamp(flAngleDiff, POD_VIEW_YAW_MIN, POD_VIEW_YAW_MAX);
  ...
  flAngleDiff = std::clamp(flAngleDiff, POD_VIEW_PITCH_MIN, POD_VIEW_PITCH_MAX);
...
//-----------------------------------------------------------------------------
void C_PropVehiclePrisonerPod::GetVehicleClipPlanes(float &flZNear,
                                                    float &flZFar) const {
