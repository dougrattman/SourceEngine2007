...
class CTFProgressBar : public vgui::ImagePanel {
 ...
 private:
  ...
  CPanelAnimationVar(Color, m_clrActive, "color_active",
                     "TimerProgress.Active");
  CPanelAnimationVar(Color, m_clrInActive, "color_inactive",
                     "TimerProgress.InActive");
  CPanelAnimationVar(Color, m_clrWarning, "color_warning",
                     "TimerProgress.Active");
...
class CTFHudTimeStatus : public vgui::EditablePanel, public CGameEventListener {
 ...
 private:
  ...
  // we'll have a second label/bg set for the SuddenDeath panel in case we want
  // to change the look from the Overtime label
