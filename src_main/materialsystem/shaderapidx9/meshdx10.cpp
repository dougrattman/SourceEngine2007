...
//-----------------------------------------------------------------------------
CVertexBufferDx10::CVertexBufferDx10(ShaderBufferType_t type,
...
CVertexBufferDx10::~CVertexBufferDx10() { Free(); }
...
//-----------------------------------------------------------------------------
bool CVertexBufferDx10::IsDynamic() const { return m_bIsDynamic; }
...
// Lock, unlock
//-----------------------------------------------------------------------------
bool CVertexBufferDx10::Lock(int nMaxVertexCount, bool bAppend,
                             VertexDesc_t &desc) {
  ...
  if (bAppend) {
    ...
    map = (m_nFirstUnwrittenOffset == 0) ? D3D10_MAP_WRITE_DISCARD
  ...
  ComputeVertexDescription(
      (unsigned char *)pLockedData + m_nFirstUnwrittenOffset, m_VertexFormat,
      desc);
...
// constructor, destructor
//-----------------------------------------------------------------------------
CIndexBufferDx10::CIndexBufferDx10(ShaderBufferType_t type,
...
CIndexBufferDx10::~CIndexBufferDx10() { Free(); }
...
// Returns true if the buffer is dynamic
//-----------------------------------------------------------------------------
bool CIndexBufferDx10::IsDynamic() const { return m_bIsDynamic; }
...
//-----------------------------------------------------------------------------
bool CIndexBufferDx10::Lock(int nMaxIndexCount, bool bAppend,
                            IndexDesc_t &desc) {
  ...
  desc.m_pIndices = (unsigned short *)((unsigned char *)pLockedData +
...
//-----------------------------------------------------------------------------
void CIndexBufferDx10::ModifyBegin(bool bReadOnly, int nFirstIndex,
...
CMeshDx10::~CMeshDx10() { delete[] m_pVertexMemory; }
...
void CMeshDx10::ModifyBeginEx(bool bReadOnly, int firstVertex, int numVerts,
...
void CMeshDx10::ModifyBegin(int firstVertex, int numVerts, int firstIndex,
...
int CMeshDx10::VertexCount() const { return 0; }
...
void CMeshDx10::ValidateData(int numVerts, int numIndices,
