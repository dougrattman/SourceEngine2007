...
the_interface IMeshMgr {
 public:
  ...
  virtual IIndexBuffer *CreateIndexBuffer(
      ShaderBufferType_t indexBufferType, MaterialIndexFormat_t fmt,
  ...
  virtual VertexFormat_t ComputeVertexFormat(
      unsigned int flags, int numTexCoords, int *pTexCoordDimensions,
      int numBoneWeights, int userDataSize) const = 0;
  ...
  virtual IVertexBuffer *GetDynamicVertexBuffer(IMaterial * pMaterial,
                                                bool buffered = true) = 0;
  virtual IIndexBuffer *GetDynamicIndexBuffer(IMaterial * pMaterial,
                                              bool buffered = true) = 0;
