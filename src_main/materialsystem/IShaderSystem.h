...
#ifndef SOURCE_MATERIALSYSTEM_ISHADERSYSTEM_H_
#define SOURCE_MATERIALSYSTEM_ISHADERSYSTEM_H_
...
the_interface IShaderSystem {
 public:
  virtual ShaderAPITextureHandle_t GetShaderAPITextureBindHandle(
      ITexture * pTexture, int nFrameVar, int nTextureChannel = 0) = 0;
  ...
  virtual void BindTexture(Sampler_t sampler1, Sampler_t sampler2,
                           ITexture * pTexture, int nFrameVar = 0) = 0;
...
#endif  // SOURCE_MATERIALSYSTEM_ISHADERSYSTEM_H_
