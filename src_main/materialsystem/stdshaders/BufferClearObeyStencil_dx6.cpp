...
BEGIN_SHADER_FLAGS(BufferClearObeyStencil_DX6,
                   "Help for BufferClearObeyStencil_DX6", SHADER_NOT_EDITABLE)

BEGIN_SHADER_PARAMS
SHADER_PARAM(CLEARCOLOR, SHADER_PARAM_TYPE_INTEGER, "1",
             "activates clearing of color")
SHADER_PARAM(CLEARDEPTH, SHADER_PARAM_TYPE_INTEGER, "1",
             "activates clearing of depth")
END_SHADER_PARAMS
