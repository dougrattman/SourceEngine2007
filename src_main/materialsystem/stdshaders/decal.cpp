...
SHADER_INIT_PARAMS() { SET_FLAGS(MATERIAL_VAR_NO_DEBUG_OVERRIDE); }
...
SHADER_DRAW {
  ...
  SHADOW_STATE {
    ...
    pShaderShadow->CustomTextureOperation(
        ...
        SHADER_TEXOP_BLEND_PREVIOUSSTAGEALPHA, SHADER_TEXARG_CONSTANTCOLOR,
  ...
  SHADOW_STATE {
    ...
    if (IS_FLAG_SET(MATERIAL_VAR_VERTEXCOLOR)) {
      ...
      pShaderShadow->CustomTextureOperation(
          ...
          SHADER_TEXOP_SELECTARG1, SHADER_TEXARG_TEXTURE, SHADER_TEXARG_NONE);
    }
  ...
  DYNAMIC_STATE { SetColorState(COLOR); }
  Draw();
}
END_SHADER
