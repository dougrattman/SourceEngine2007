...
BEGIN_VS_SHADER(Eyes_dx6, "Help for Eyes")
...
void SetTextureTransform(IMaterialVar** params, IShaderDynamicAPI* pShaderAPI,
                         MaterialMatrixMode_t textureTransform, int uparam,
                         int vparam) {
  Vector4D u, v;
...
void DrawFlashlight_Iris(IMaterialVar** params, IShaderDynamicAPI* pShaderAPI,
...
void DrawFlashlight(IMaterialVar** params, IShaderDynamicAPI* pShaderAPI,
  ...
  DrawFlashlight_dx70(params, pShaderAPI, pShaderShadow, FLASHLIGHTTEXTURE,
                      FLASHLIGHTTEXTUREFRAME, true);

  // iris
  DrawFlashlight_Iris(params, pShaderAPI, pShaderShadow);
}

void DrawUsingSoftwareLighting(IMaterialVar** params,
