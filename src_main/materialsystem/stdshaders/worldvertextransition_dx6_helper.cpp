...
void InitWorldVertexTransition_DX6(CBaseShader *pShader, IMaterialVar **params,
...
static void DrawFlashlightPass(CBaseShader *pShader, IMaterialVar **params,
                               IShaderDynamicAPI *pShaderAPI,
                               IShaderShadow *pShaderShadow, int nPass,
                               WorldVertexTransition_DX6_Vars_t &info) {
  SHADOW_STATE {
  ...
  DYNAMIC_STATE {
    ...
    pShader->BindTexture(SHADER_SAMPLER0, FLASHLIGHTTEXTURE,
...
void DrawWorldVertexTransition_DX6(CBaseShader *pShader, IMaterialVar **params,
  ...
  SHADOW_STATE {
    ...
    pShaderShadow->DrawFlags(SHADER_DRAW_COLOR | SHADER_DRAW_POSITION |
  ...
  SHADOW_STATE {
    ...
    pShaderShadow->CustomTextureOperation(
        SHADER_TEXTURE_STAGE1, SHADER_TEXCHANNEL_COLOR, SHADER_TEXOP_MODULATE2X,
