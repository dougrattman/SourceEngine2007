...
BEGIN_SHADER_FLAGS(IntroScreenSpaceEffect_dx60,
                   "Help for IntroScreenSpaceEffect_dx60", SHADER_NOT_EDITABLE)
BEGIN_SHADER_PARAMS
...
SHADER_DRAW {
  SHADOW_STATE {
    ...
    pShaderShadow->CustomTextureOperation(
        SHADER_TEXTURE_STAGE1, SHADER_TEXCHANNEL_COLOR, SHADER_TEXOP_ADD,
  ...
  DYNAMIC_STATE {
    switch (params[MODE]->GetIntValue()) {
      case 7:
        pShaderAPI->BindStandardTexture(SHADER_SAMPLER0,
