...
BEGIN_VS_SHADER_FLAGS(floatcombine, "Help for floatcombine",
                      SHADER_NOT_EDITABLE)
BEGIN_SHADER_PARAMS
...
SHADER_DRAW {
  ...
  DYNAMIC_STATE {
    ...
    float v0[4] = {1.0f / base_texture->GetActualWidth(),
                   1.0f / base_texture->GetActualHeight(),
                   1.0f / bloom_texture->GetActualWidth(),
                   1.0f / bloom_texture->GetActualHeight()};
