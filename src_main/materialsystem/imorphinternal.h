...
#ifndef SOURCE_MATERIALSYSTEM_IMORPHINTERNAL_H_
#define SOURCE_MATERIALSYSTEM_IMORPHINTERNAL_H_
...
the_interface IMorphMgrRenderContext{public : };
...
the_interface IMorphMgr {
 public:
  ...
  virtual void BeginMorphAccumulation(IMorphMgrRenderContext *
                                      pRenderContext) = 0;
  virtual void EndMorphAccumulation(IMorphMgrRenderContext *
                                    pRenderContext) = 0;

  // Accumulate a morph
  virtual void AccumulateMorph(IMorphMgrRenderContext * pRenderContext,
...
#endif  // SOURCE_MATERIALSYSTEM_IMORPHINTERNAL_H_
