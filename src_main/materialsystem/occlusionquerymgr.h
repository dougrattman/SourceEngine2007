...
#ifndef SOURCE_MATERIALSYSTEM_OCCLUSIONQUERY_H_
#define SOURCE_MATERIALSYSTEM_OCCLUSIONQUERY_H_
...
class COcclusionQueryMgr {
 public:
  ...
  int OcclusionQuery_GetNumPixelsRendered(OcclusionQueryObjectHandle_t h,
                                          bool bDoQuery);
  void OcclusionQuery_IssueNumPixelsRenderedQuery(
...
#endif  // SOURCE_MATERIALSYSTEM_OCCLUSIONQUERY_H_
