...
static PhonemeMap_t g_Phonemes[] = {
    ...
    {"ay", 0x0251, 1.0f, false,
     "fAther : low back unrounded vowel"},  // or possibly +0x026a (ih)
    {"ng", 0x014b, 1.0f, false, "siNG : voiced velar nasal"},  // nx
    {"aw", 0x0251, 1.2f, false,
     "fAther : low back unrounded vowel"},  // // vOWel,   // aa + uh???
...
int NumPhonemes() { return std::size(g_Phonemes); }
