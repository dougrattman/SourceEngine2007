...
class CSPVertList {
 public:
  ...
  CSPVertList(Vector const &vert1, CSPColor const &color1, Vector const &vert2,
              CSPColor const &color2, Vector const &vert3,
...
abstract_class IScratchPad3D {
 ...
 public:
  ...
  // this to false and call Flush() manually when you want the file written out.
 ...
 public:
  ...
  // If the corners are NULL, then the image is drawn in the XY plane from
  // (-100,-100) to (100,100).
