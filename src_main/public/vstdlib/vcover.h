...
class CVCoverage {
 public:
  ...
  void Reset() { m_locations.RemoveAll(); }
  ...
  void Report() {
    for (int i = m_locations.FirstInorder(); i != m_locations.InvalidIndex();
         i = m_locations.NextInorder(i)) {
...
#endif  // SOURCE_VSTDLIB_VCOVER_H_
