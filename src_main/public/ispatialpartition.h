...
typedef u16 SpatialPartitionHandle_t;
...
the_interface ISpatialPartition {
 public:
  ...
  virtual void EnumerateElementsInBox(
      ...
      const Vector& maxs, bool coarseTest, IPartitionEnumerator* pIterator) = 0;
  ...
  virtual void RenderObjectsInPlayerLeafs(
      const Vector& vecPlayerMin, const Vector& vecPlayerMax, float flTime) = 0;
