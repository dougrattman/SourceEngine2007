...
// has attributes such as: keys that may be set, the default size and color of
// the entity, inputs and outputs, and any default models that are created when
// the entity is placed.
//
// The game classes support multiple inheritence through aggregation of
// properties.
