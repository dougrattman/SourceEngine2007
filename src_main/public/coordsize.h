...
///////////////////////////////////////////////////////////////////////////////////////////////////////
// The following are Bit Packing Diagrams for client/server Coordinate BitField
// Messages
///////////////////////////////////////////////////////////////////////////////////////////////////////
//
//  	"Coordinates" = +/-16384.9375	(21 Bits Max)
//
// | IntegerFlagBit:1 | FractionFlagBit:1 | SignBit:1 | IntegerField:14 |
// FractionPart:4 |		Total
// --------------------------------------------------------------------------------------------------
// 0 		0 	- 	- 	- 	2
// 0 		1 	x 	- 	xxxx 7
...
//
// | NonZeroX:1 | NonZeroY:1 | NonZeroZ:1 |  0..3 "Coordinates"	|
// BitField Total
// -------------------------------------------------------------------------------
// 0 0 	0 - 		3
...
///////////////////////////////////////////////////////////////////////////////////////////////////////
// The following are Bit Packing Diagrams for client/server Normal BitField
// Messages
///////////////////////////////////////////////////////////////////////////////////////////////////////
//
...
//
// | NonZeroX:1 | NonZeroY:1 |  0..2 "Coordinates"	| Z Sign Bit |
// BitField Total
// -------------------------------------------------------------------------------
// 0 0 	- 		x 3
// 0 1 12 Bits 		x 14
