...
// YOU MUST INCLUDE THIS FILE INTO ANY PROJECT WHICH USES THE movieobjects.lib
// FILE This hack causes the class factories for the element types to be
// imported into the compiled code...
