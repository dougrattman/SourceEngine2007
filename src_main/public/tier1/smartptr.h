...
#ifndef SOURCE_TIER1_SMARTPTR_H_
#define SOURCE_TIER1_SMARTPTR_H_
...
//
//	CArrayAutoPtr
//		is a smart wrapper for an array pointer on the stack that
// performs "delete []" upon destruction.
//
//	No reference counting is performed, copying is prohibited "s_p2.Attach(
// s_p1.Detach() )" should be used 	for readability and ease of maintenance.
//
...
// saves the value, assigns new value upon construction, restores saved value
// upon destruction.
...
#endif  // SOURCE_TIER1_SMARTPTR_H_
