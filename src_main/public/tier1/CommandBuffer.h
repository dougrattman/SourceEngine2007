...
#ifndef SOURCE_TIER1_COMMANDBUFFER_H_
#define SOURCE_TIER1_COMMANDBUFFER_H_
...
class CCommandBuffer {
 ...
 private:
  ...
  // command
  void GetNextCommandLength(const char *pText, int nMaxLen, int *pCommandLength,
...
#endif  // SOURCE_TIER1_COMMANDBUFFER_H_
