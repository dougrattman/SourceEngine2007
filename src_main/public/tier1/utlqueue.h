...
#ifndef SOURCE_TIER1_UTLQUEUE_H_
#define SOURCE_TIER1_UTLQUEUE_H_
...
class CUtlQueue {
 public:
  ...
  // checks if an element of this value already exists on the stack, returns
  // true if it does
...
#endif  // SOURCE_TIER1_UTLQUEUE_H_
