...
//
// Purpose: A growable array class that maintains a free list and keeps elements
// in the same location.

#ifndef SOURCE_TIER1_UTLVECTOR_H_
#define SOURCE_TIER1_UTLVECTOR_H_
...
#endif  // SOURCE_TIER1_UTLVECTOR_H_
