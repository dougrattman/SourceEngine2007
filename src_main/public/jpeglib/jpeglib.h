...
struct jpeg_destination_mgr {
  JOCTET *next_output_byte; /* => next uint8_t to write in buffer */
  size_t free_in_buffer;    /* # of uint8_t spaces remaining in buffer */
...
struct jpeg_source_mgr {
  const JOCTET *next_input_byte; /* => next uint8_t to read from buffer */
...
#ifdef JPEGLIB_USE_STDIO  // allow the use of these functions in specific cases
                          // where
