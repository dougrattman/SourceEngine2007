...
#ifndef SOURCE_VGUI_IINPUTINTERNAL_H_
#define SOURCE_VGUI_IINPUTINTERNAL_H_
...
the_interface IInputInternal : public IInput {
 public:
  ...
  // Called to handle explicit calls to CursorSetPos after input processing is
  // complete
...
#endif  // SOURCE_VGUI_IINPUTINTERNAL_H_
