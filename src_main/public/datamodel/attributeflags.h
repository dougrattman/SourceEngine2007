...
enum {
  ...
  FATTRIB_DIRTY = (1 << 7),  // Indicates the attribute has been changed since
                             // the resolve phase
  FATTRIB_HAS_CALLBACK = (1 << 8),  // Indicates that this will notify its owner
                                    // and/or other elements when it changes
  FATTRIB_EXTERNAL = (1 << 9),  // Indicates this attribute's data is externally
                                // owned (in a CDmElement somewhere)
  FATTRIB_TOPOLOGICAL =
