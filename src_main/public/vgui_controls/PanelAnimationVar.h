  ...
  class PanelAnimationVar_##name {                                           \
   public:                                                                   \
    static void InitVar() {                                                  \
      ...
      if (!bAdded) {                                                         \
        bAdded = true;                                                       \
        AddToAnimationMap(scriptname, typealias, #name, defaultvalue, false, \
                          ThisClass::GetVar_##name);                         \
      }                                                                      \
    }                                                                        \
  ...
  class PanelAnimationVar_##name {                                          \
   public:                                                                  \
    static void InitVar() {                                                 \
      ...
      if (!bAdded) {                                                        \
        bAdded = true;                                                      \
        AddToAnimationMap(scriptname, typealias, #name, defaultvalue, true, \
                          ThisClass::GetVar_##name);                        \
      }                                                                     \
    }                                                                       \
    PanelAnimationVar_##name() { PanelAnimationVar_##name::InitVar(); }     \
...
struct PanelAnimationMap {
  PanelAnimationMap() : baseMap{nullptr}, pfnClassName{nullptr} {}
