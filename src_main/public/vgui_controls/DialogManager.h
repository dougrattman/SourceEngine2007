...
class DialogManager {
 ...
 private:
  // checks if an index in the dialog list is valid; if it has been deleted,
  // removes the entry
...
inline DialogManager<TDialog, I>::DialogManager(
    CreateNewDialogFunc_t createDialogFunc) {
...
template <class TDialog, class I>
inline TDialog *DialogManager<TDialog, I>::FindDialog(I dialogID,
                                                      bool bCreate) {
...
template <class TDialog, class I>
inline TDialog *DialogManager<TDialog, I>::ActivateDialog(I dialogID,
                                                          bool bCreate) {
