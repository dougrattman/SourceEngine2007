...
class COperationFileListFrame : public vgui::Frame {
 ...
 public:
  // NOTE: The dialog ID is used to allow dialogs to have different
  // configurations saved
  COperationFileListFrame(vgui::Panel *pParent, const char *pTitle,
                          const char *pColumnHeader, bool bShowDescription,
                          bool bShowOkOnly = false, int nDialogID = 1);
...
class CPerforceFileListFrame : public COperationFileListFrame {
 ...
 public:
  CPerforceFileListFrame(vgui::Panel *pParent, const char *pTitle,
                         const char *pColumnHeader, PerforceAction_t action);
...
//		2) If you indicate to not add a file for add but don't hit
//cancel
...
void ShowPerforceQuery(vgui::Panel *pParent, const char *pFileName,
                       ...
                       PerforceAction_t actionFilter = PERFORCE_ACTION_NONE);
