...
class CViewSetupV1 {
 public:
  ...
  bool clearDepth;
  // NOTE: This is for a workaround on ATI with building cubemaps.  Clearing
  // just the viewport doesn't seem to work properly.
  ...
  // Use this for situations like water where you want to render the aspect
  // ratio of the back buffer into a square (or otherwise) render target.
