...
class IVRenderView {
 public:
  ...
  // If pMaterialOverride is non-0, then all the faces of the bmodel will
  ...
  // Installs a brush surface draw override method, 0 means use normal renderer
  ...
  virtual void DrawBrushModelShadowDepth(IClientEntity *baseentity,
                                         ...
                                         const QAngle &angles, bool bSort) = 0;
  ...
  virtual void GetMatricesForView(const CViewSetup &view, VMatrix *pWorldToView,
