...
class CAttributeAssetPickerPanel : public CAttributeBasePickerPanel {
 ...
 public:
  CAttributeAssetPickerPanel(vgui::Panel *parent,
...
#define IMPLEMENT_ATTRIBUTE_ASSET_PICKER(_className, _popupTitle, _assetType, \
                                         _assetExt, _assetSubDir,             \
                                         _assetTextType)                      \
  CBaseAssetPickerFrame *_className::CreateAssetPickerFrame() {               \
    return new CAssetPickerFrame(this, _popupTitle, _assetType, _assetExt,    \
                                 _assetSubDir, _assetTextType);               \
  }
...
#define IMPLEMENT_ATTRIBUTE_ASSET_PREVIEW_PICKER(_className, _pickerClassName, \
                                                 _popupTitle)                  \
  CBaseAssetPickerFrame *_className::CreateAssetPickerFrame() {                \
