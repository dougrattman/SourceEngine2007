...
class CAssetBuilder : public vgui::EditablePanel {
 ...
 private:
  ...
  void ShowSourceFileBrowser(const char *pTitle, DmeMakefileType_t *pSourceType,
  ...
  void BuildFileIDList(CDmeMakefile *pMakeFile,
...
//-----------------------------------------------------------------------------
class CAssetBuilderFrame : public vgui::Frame,
