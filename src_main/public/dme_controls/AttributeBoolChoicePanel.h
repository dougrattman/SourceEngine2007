...
class CAttributeBoolChoicePanel : public CBaseAttributeChoicePanel {
 ...
 public:
  CAttributeBoolChoicePanel(vgui::Panel *parent,
                            const AttributeWidgetInfo_t &info);

 private:
  // Derived classes can re-implement this to fill the combo box however they
  // like
  virtual void PopulateComboBox(vgui::ComboBox *pComboBox);
  virtual void SetAttributeFromComboBox(vgui::ComboBox *pComboBox,
