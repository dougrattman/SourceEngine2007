...
// The header identifies the vertex format of the data and the atomic sizes of
// each component. The hierarchial mesh is flattened for dma but the vertex
// counts are available per mesh to transfer each mesh individually.
...
struct FileHeader_t {
  ...
  // this won't be adequate, need some concept of byte format i.e. rgbexp32 vs
  // rgba8888
