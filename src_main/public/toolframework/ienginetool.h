...
class IEngineToolFramework : public IBaseInterface {
 public:
  ...
  // Something like this
  // virtual void		AddMessageHandler( int wm_message, bool (*pfnCallback)(
  // int wm_message, int wParam, int lParam ) ) = 0; virtual void
...
class IEngineTool : public IEngineToolFramework {
 public:
  ...
  virtual int StartSound(int iUserData, bool staticsound, int iEntIndex,
                         ...
                         float delay = 0.0f, int speakerentity = -1) = 0;
  ...
  // or overlays See cdll_int.h for enum RenderViewInfo_t for specifying
  // whatToRender
