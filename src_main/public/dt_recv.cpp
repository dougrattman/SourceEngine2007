...
void RecvTable::Construct(RecvProp *pProps, int nProps,
...
RecvProp RecvPropFloat(const char *pVarName, int offset, int sizeofVar,
                       int flags, RecvVarProxyFn varProxy) {
  RecvProp ret;
...
RecvProp RecvPropVector(const char *pVarName, int offset, int sizeofVar,
                        int flags, RecvVarProxyFn varProxy) {
  RecvProp ret;
...
RecvProp RecvPropInt(const char *pVarName, int offset, int sizeofVar, int flags,
                     RecvVarProxyFn varProxy) {
  RecvProp ret;
...
RecvProp RecvPropDataTable(const char *pVarName, int offset, int flags,
                           RecvTable *pTable,
...
RecvProp RecvPropArray3(const char *pVarName, int offset, int sizeofVar,
                        int elements, RecvProp pArrayProp,
                        DataTableRecvVarProxyFn varProxy) {
  ...
  RecvTable *pTable =
      new RecvTable(pProps, elements, pVarName);  // TODO free that again
