...
//-----------------------------------------------------------------------------
the_interface ITextureDictionary {
 public:
  ...
  virtual void GetTextureTexCoords(int id, float &s0, float &t0, float &s1,
                                   float &t1) = 0;
  ...
  virtual void SetSubTextureRGBA(int id, int drawX, int drawY,
                                 unsigned const char *rgba, int subTextureWide,
                                 int subTextureTall) = 0;

  virtual void SetTextureRGBAEx(int id, const char *rgba, int wide, int tall,
