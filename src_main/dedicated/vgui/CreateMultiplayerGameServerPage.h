...
#ifndef SOURCE_DEDICATED_CREATEMULTIPLAYERGAMESERVERPAGE_H_
#define SOURCE_DEDICATED_CREATEMULTIPLAYERGAMESERVERPAGE_H_
...
struct serveritem_t {
  ...
  bool doNotRefresh;  // server is marked as not responding and should no longer
                      // be refreshed
  ...
  bool password;
  bool secure;
  bool loadedFromFile;  // true if this entry was loaded from file rather than
                        // comming from the master
...
#endif  // SOURCE_DEDICATED_CREATEMULTIPLAYERGAMESERVERPAGE_H_
