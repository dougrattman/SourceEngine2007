...
void CTextConsole::SetVisible(bool visible) { m_ConsoleVisible = visible; }

bool CTextConsole::IsVisible() { return m_ConsoleVisible; }
...
void CTextConsole::ReceiveStandardChar(const char ch) {
  ...
  Echo(m_szConsoleText + m_nCursorPosition,
