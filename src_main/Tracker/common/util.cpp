...
// Purpose: This function is supposed to localise the strings, but for now just
// return internal value Input  : *stringName - Output : const char
const char *CUtil::GetString(const char *stringName) { return stringName; }
