...
//-----------------------------------------------------------------------------
static const matrix3x4_t *ComputeSkinMatrix(int nBoneCount,
                                            const float *pJointWeight,
                                            const int *pJointIndices,
  ...
  switch (nBoneCount) {
    ...
    case 3: {
      ...
      result[0][0] = boneMat0[0][0] * flWeight0 + boneMat1[0][0] * flWeight1 +
                     boneMat2[0][0] * flWeight2;
      result[0][1] = boneMat0[0][1] * flWeight0 + boneMat1[0][1] * flWeight1 +
                     boneMat2[0][1] * flWeight2;
      result[0][2] = boneMat0[0][2] * flWeight0 + boneMat1[0][2] * flWeight1 +
                     boneMat2[0][2] * flWeight2;
      result[0][3] = boneMat0[0][3] * flWeight0 + boneMat1[0][3] * flWeight1 +
                     boneMat2[0][3] * flWeight2;
      result[1][0] = boneMat0[1][0] * flWeight0 + boneMat1[1][0] * flWeight1 +
                     boneMat2[1][0] * flWeight2;
      result[1][1] = boneMat0[1][1] * flWeight0 + boneMat1[1][1] * flWeight1 +
                     boneMat2[1][1] * flWeight2;
      result[1][2] = boneMat0[1][2] * flWeight0 + boneMat1[1][2] * flWeight1 +
                     boneMat2[1][2] * flWeight2;
      result[1][3] = boneMat0[1][3] * flWeight0 + boneMat1[1][3] * flWeight1 +
                     boneMat2[1][3] * flWeight2;
      result[2][0] = boneMat0[2][0] * flWeight0 + boneMat1[2][0] * flWeight1 +
                     boneMat2[2][0] * flWeight2;
      result[2][1] = boneMat0[2][1] * flWeight0 + boneMat1[2][1] * flWeight1 +
                     boneMat2[2][1] * flWeight2;
      result[2][2] = boneMat0[2][2] * flWeight0 + boneMat1[2][2] * flWeight1 +
                     boneMat2[2][2] * flWeight2;
      result[2][3] = boneMat0[2][3] * flWeight0 + boneMat1[2][3] * flWeight1 +
                     boneMat2[2][3] * flWeight2;
    }
      return &result;
    ...
    case 4: {
      ...
      result[0][0] = boneMat0[0][0] * flWeight0 + boneMat1[0][0] * flWeight1 +
                     boneMat2[0][0] * flWeight2 + boneMat3[0][0] * flWeight3;
      result[0][1] = boneMat0[0][1] * flWeight0 + boneMat1[0][1] * flWeight1 +
                     boneMat2[0][1] * flWeight2 + boneMat3[0][1] * flWeight3;
      result[0][2] = boneMat0[0][2] * flWeight0 + boneMat1[0][2] * flWeight1 +
                     boneMat2[0][2] * flWeight2 + boneMat3[0][2] * flWeight3;
      result[0][3] = boneMat0[0][3] * flWeight0 + boneMat1[0][3] * flWeight1 +
                     boneMat2[0][3] * flWeight2 + boneMat3[0][3] * flWeight3;
      result[1][0] = boneMat0[1][0] * flWeight0 + boneMat1[1][0] * flWeight1 +
                     boneMat2[1][0] * flWeight2 + boneMat3[1][0] * flWeight3;
      result[1][1] = boneMat0[1][1] * flWeight0 + boneMat1[1][1] * flWeight1 +
                     boneMat2[1][1] * flWeight2 + boneMat3[1][1] * flWeight3;
      result[1][2] = boneMat0[1][2] * flWeight0 + boneMat1[1][2] * flWeight1 +
                     boneMat2[1][2] * flWeight2 + boneMat3[1][2] * flWeight3;
      result[1][3] = boneMat0[1][3] * flWeight0 + boneMat1[1][3] * flWeight1 +
                     boneMat2[1][3] * flWeight2 + boneMat3[1][3] * flWeight3;
      result[2][0] = boneMat0[2][0] * flWeight0 + boneMat1[2][0] * flWeight1 +
                     boneMat2[2][0] * flWeight2 + boneMat3[2][0] * flWeight3;
      result[2][1] = boneMat0[2][1] * flWeight0 + boneMat1[2][1] * flWeight1 +
                     boneMat2[2][1] * flWeight2 + boneMat3[2][1] * flWeight3;
      result[2][2] = boneMat0[2][2] * flWeight0 + boneMat1[2][2] * flWeight1 +
                     boneMat2[2][2] * flWeight2 + boneMat3[2][2] * flWeight3;
      result[2][3] = boneMat0[2][3] * flWeight0 + boneMat1[2][3] * flWeight1 +
                     boneMat2[2][3] * flWeight2 + boneMat3[2][3] * flWeight3;
    }
      return &result;
  }
...
class CRenderInfo {
 public:
  ...
  void ComputeVertex(int vi, const matrix3x4_t *pPoseToWorld,
                     CDmeMesh::RenderVertexDelta_t *pDelta, Vector *pPosition,
                     Vector *pNormal, Vector4D *pTangent);
  void ComputeVertex(int vi, const matrix3x4_t *pPoseToWorld,
                     Vector *pDeltaPosition, int nStride, Vector *pPosition);
  void ComputePosition(int posIndex, const matrix3x4_t *pPoseToWorld,
                       Vector *pDeltaPosition, Vector *pPosition);
...
CRenderInfo::CRenderInfo(const CDmeVertexData *pBaseState)
    : m_PositionIndices(
          pBaseState->GetVertexIndexData(CDmeVertexData::FIELD_POSITION)),
      m_PositionData(pBaseState->GetPositionData()),
      m_NormalIndices(
          pBaseState->GetVertexIndexData(CDmeVertexData::FIELD_NORMAL)),
      m_NormalData(pBaseState->GetNormalData()),
      m_TangentIndices(
          pBaseState->GetVertexIndexData(CDmeVertexData::FIELD_TANGENT)),
...
void CRenderInfo::ComputeVertex(int vi, const matrix3x4_t *pPoseToWorld,
                                Vector *pDeltaPosition, int nDeltaStride,
                                Vector *pPosition) {
  matrix3x4_t result;
  ...
  if (m_bHasSkinningData) {
    ...
    pSkinMatrix = ComputeSkinMatrix(m_nJointCount, pJointWeight, pJointIndices,
                                    pPoseToWorld, result);
  }
  ...
  if (pDeltaPosition) {
    Vector *pDelta =
        (Vector *)((unsigned char *)pDeltaPosition + nDeltaStride * pi);
...
// Computes where a vertex is
//-----------------------------------------------------------------------------
void CRenderInfo::ComputePosition(int posIndex, const matrix3x4_t *pPoseToWorld,
                                  Vector *pDeltaPosition, Vector *pPosition) {
  matrix3x4_t result;
...
void CRenderInfo::ComputeVertex(int vi, const matrix3x4_t *pPoseToWorld,
                                ...
                                Vector *pPosition, Vector *pNormal,
                                Vector4D *pTangent) {
  matrix3x4_t result;
  Vector vecMorphPosition, vecMorphNormal;
  const matrix3x4_t *pSkinMatrix = pPoseToWorld;
  ...
  if (m_bHasTangentData) {
    ...
    VectorRotate(tangentData.AsVector3D(), *pSkinMatrix,
                 pTangent->AsVector3D());
...
void CDmeMesh::OnDestruction() {
  ...
  for (int i = 0; i < nCount; ++i) {
    if (!m_hwFaceSets[i].m_bBuilt) continue;
  ...
  if (pAttribute == m_DeltaStates.GetAttribute()) {
    ...
    for (int i = 0; i < MESH_DELTA_WEIGHT_TYPE_COUNT; ++i) {
      ...
      if (nWeightCount < nDeltaStateCount) {
        ...
        m_DeltaStateWeights[i].RemoveMultiple(nWeightCount,
                                              nWeightCount - nDeltaStateCount);
      }
    }
  }
}
...
//-----------------------------------------------------------------------------
template <class T>
bool CDmeMesh::AddVertexDelta(CDmeVertexData *pBaseState, void *pVertexData,
                              int nStride,
                              CDmeVertexDataBase::StandardFields_t fieldId,
                              int nIndex, bool bDoLag) {
  CDmeVertexDeltaData *pDeltaState = GetDeltaState(nIndex);

  if (!pBaseState || !pDeltaState) return false;

  const FieldIndex_t nBaseFieldIndex = pBaseState->FindFieldIndex(
      fieldId == CDmeVertexData::FIELD_WRINKLE ? CDmeVertexData::FIELD_TEXCOORD
                                               : fieldId);
  const FieldIndex_t nDeltaFieldIndex = pDeltaState->FindFieldIndex(fieldId);
  if (nBaseFieldIndex < 0 || nDeltaFieldIndex < 0) return false;
  ...
  const float flWeight =
      m_DeltaStateWeights[MESH_DELTA_WEIGHT_NORMAL][nIndex].x;

  const FieldIndex_t nSpeedFieldIndex =
      pBaseState->FindFieldIndex(CDmeVertexData::FIELD_MORPH_SPEED);
  ...
  const float flLaggedWeight =
      m_DeltaStateWeights[MESH_DELTA_WEIGHT_LAGGED][nIndex].x;

  const CDmrArrayConst<int> speedIndices =
      pBaseState->GetIndexData(nSpeedFieldIndex);
  const CDmrArrayConst<float> speedDelta =
      pBaseState->GetVertexData(nSpeedFieldIndex);
  for (int j = 0; j < nDeltaCount; ++j) {
    int nDataIndex = indices.Get(j);
...
//
//-----------------------------------------------------------------------------
void CDmeMesh::AddTexCoordDelta(RenderVertexDelta_t *pRenderDelta,
                                float flWeight,
                                CDmeVertexDeltaData *pDeltaState) {
  FieldIndex_t nFieldIndex =
      pDeltaState->FindFieldIndex(CDmeVertexDeltaData::FIELD_TEXCOORD);
  if (nFieldIndex < 0) return;
...
//
//-----------------------------------------------------------------------------
void CDmeMesh::AddColorDelta(RenderVertexDelta_t *pRenderDelta, float flWeight,
                             CDmeVertexDeltaData *pDeltaState) {
  FieldIndex_t nFieldIndex =
      pDeltaState->FindFieldIndex(CDmeVertexDeltaData::FIELD_COLOR);
  if (nFieldIndex < 0) return;
...
template <class T>
bool CDmeMesh::AddStereoVertexDelta(
    CDmeVertexData *pBaseState, void *pVertexData, int nStride,
    CDmeVertexDataBase::StandardFields_t fieldId, int nIndex, bool bDoLag) {
  CDmeVertexDeltaData *pDeltaState = GetDeltaState(nIndex);
  if (!pBaseState || !pDeltaState) return false;
  ...
  const CDmrArray<int> indices = pDeltaState->GetIndexData(nDeltaFieldIndex);
  const CDmrArray<T> delta = pDeltaState->GetVertexData(nDeltaFieldIndex);
  const CUtlVector<int> &balanceIndices =
      pBaseState->GetVertexIndexData(CDmeVertexData::FIELD_BALANCE);
  ...
  float flLeftWeightLagged =
      m_DeltaStateWeights[MESH_DELTA_WEIGHT_LAGGED][nIndex].x;
  float flRightWeightLagged =
      m_DeltaStateWeights[MESH_DELTA_WEIGHT_LAGGED][nIndex].y;

  const CDmrArray<int> pSpeedIndices =
      pBaseState->GetIndexData(nSpeedFieldIndex);
  const CDmrArray<float> pSpeedDelta =
      pBaseState->GetVertexData(nSpeedFieldIndex);
  for (int j = 0; j < nDeltaCount; ++j) {
    int nDataIndex = indices.Get(j);
    const CUtlVector<int> &list =
    ...
    float flLaggedWeight =
        Lerp(flRightAmount, flLeftWeightLagged, flRightWeightLagged);
...
//-----------------------------------------------------------------------------
bool CDmeMesh::BuildDeltaMesh(int nVertices,
                              RenderVertexDelta_t *pRenderDelta) {
  ...
  Assert(m_DeltaStateWeights[MESH_DELTA_WEIGHT_NORMAL].Count() ==
         m_DeltaStateWeights[MESH_DELTA_WEIGHT_LAGGED].Count());

  CDmeVertexData *pBindState = GetBindBaseState();

  const FieldIndex_t nBalanceFieldIndex =
      pBindState->FindFieldIndex(CDmeVertexDeltaData::FIELD_BALANCE);
  const FieldIndex_t nSpeedFieldIndex =
      pBindState->FindFieldIndex(CDmeVertexDeltaData::FIELD_MORPH_SPEED);
  ...
  if (nBalanceFieldIndex < 0) {
    for (int i = 0; i < nCount; ++i) {
      ...
      if (flWeight <= 0.0f && flLaggedWeight <= 0.0f) continue;

      // prepare vertices
      CDmeVertexDeltaData *pDeltaState = GetDeltaState(i);
      AddVertexDelta<Vector>(pBindState, &pRenderDelta->m_vecDeltaPosition,
                             sizeof(RenderVertexDelta_t),
                             CDmeVertexDeltaData::FIELD_POSITION, i, bDoLag);
      AddVertexDelta<Vector>(pBindState, &pRenderDelta->m_vecDeltaNormal,
                             sizeof(RenderVertexDelta_t),
                             CDmeVertexDeltaData::FIELD_NORMAL, i, bDoLag);
      AddTexCoordDelta(pRenderDelta, flWeight, pDeltaState);
      AddColorDelta(pRenderDelta, flWeight, pDeltaState);
      bool bWrinkle =
          AddVertexDelta<float>(pBindState, &pRenderDelta->m_flDeltaWrinkle,
                                sizeof(RenderVertexDelta_t),
                                CDmeVertexDeltaData::FIELD_WRINKLE, i, bDoLag);
  ...
  for (int i = 0; i < nCount; ++i) {
    ...
    float flLeftWeightLagged =
        m_DeltaStateWeights[MESH_DELTA_WEIGHT_LAGGED][i].x;
    float flRightWeightLagged =
        m_DeltaStateWeights[MESH_DELTA_WEIGHT_LAGGED][i].y;
    if (flLeftWeight <= 0.0f && flRightWeight <= 0.0f &&
    ...
    AddStereoVertexDelta<Vector>(pBindState, &pRenderDelta->m_vecDeltaPosition,
                                 sizeof(RenderVertexDelta_t),
                                 CDmeVertexDeltaData::FIELD_POSITION, i,
                                 bDoLag);
    AddStereoVertexDelta<Vector>(pBindState, &pRenderDelta->m_vecDeltaNormal,
                                 sizeof(RenderVertexDelta_t),
                                 CDmeVertexDeltaData::FIELD_NORMAL, i, bDoLag);
    bWrinkle = AddStereoVertexDelta<float>(
        pBindState, &pRenderDelta->m_flDeltaWrinkle,
        sizeof(RenderVertexDelta_t), CDmeVertexDeltaData::FIELD_WRINKLE, i,
        bDoLag);
    bHasWrinkleDelta = bHasWrinkleDelta || bWrinkle;
...
//-----------------------------------------------------------------------------
void CDmeMesh::WriteTriangluatedIndices(const CDmeVertexData *pBaseState,
  ...
  while (nFirstIndex < nIndexCount) {
    ...
    if (nVertexCount >= 3) {
      ...
      ComputeTriangulatedIndices(pBaseState, pFaceSet, nFirstIndex, pIndices,
                                 nOutCount);
...
// Draws the mesh when it uses too many bones
//-----------------------------------------------------------------------------
void CDmeMesh::DrawDynamicMesh(CDmeFaceSet *pFaceSet, matrix3x4_t *pPoseToWorld,
                               bool bHasActiveDeltaStates,
                               CDmeDrawSettings *pDrawSettings /* = NULL */) {
  ...
  // NOTE: The Delta Data is actually indexed by the pPositionIndices,
  // pNormalIndices, etc. The fact that we're storing one delta per final vertex
  // nVertices is a waste of memory and simply implementational convenience.
  bool bHasActiveWrinkle = false;
  RenderVertexDelta_t *pVertexDelta =
      (RenderVertexDelta_t *)_alloca(nVertices * sizeof(RenderVertexDelta_t));
  ...
  // prepare vertices
  FieldIndex_t uvField =
      pBindBase->FindFieldIndex(CDmeVertexData::FIELD_TEXCOORD);
  FieldIndex_t colorField =
      pBindBase->FindFieldIndex(CDmeVertexData::FIELD_COLOR);
  ...
  const CDmrArrayConst<int> pUVIndices =
      bHasTexCoords ? pBindBase->GetIndexData(uvField) : NULL;
  ...
  if (bHasActiveWrinkle && bHasTexCoords) {
    ...
    CMeshBuilder meshBuilder;
    meshBuilder.Begin(pFlexDelta, MATERIAL_HETEROGENOUS, nVertices, 0,
                      &nFlexVertexOffset);
  ...
  const CDmrArrayConst<Vector2D> pUVData =
      bHasTexCoords ? pBindBase->GetVertexData(uvField) : NULL;
  const CDmrArrayConst<int> pColorIndices =
      bHasColors ? pBindBase->GetIndexData(colorField) : NULL;
  const CDmrArrayConst<Color> pColorData =
      bHasColors ? pBindBase->GetVertexData(colorField) : NULL;

  Vector vecPosition, vecNormal;
  Vector4D vecTangent;
  for (int vi = 0; vi < nVertices; ++vi) {
    renderInfo.ComputeVertex(vi, pPoseToWorld, pVertexDelta, &vecPosition,
                             &vecNormal, &vecTangent);
...
void CDmeMesh::RenderNormals(matrix3x4_t *pPoseToWorld,
                             RenderVertexDelta_t *pDelta) {
  ...
  Assert(renderInfo.HasPositionData());
  if (!renderInfo.HasNormalData()) return;
  ...
  while (nVerticesRemaining > 0) {
    ...
    CMeshBuilder meshBuilder;
    meshBuilder.Begin(pMesh, MATERIAL_LINES,
                      bHasTangents ? nVertices * 3 : nVertices);

    Vector vecPosition, vecNormal, vecEndPoint, vecTangentS, vecTangentT;
    Vector4D vecTangent;
    for (int vi = nFirstVertex; vi < nVertices; ++vi) {
      renderInfo.ComputeVertex(vi, pPoseToWorld, pDelta, &vecPosition,
                               &vecNormal, &vecTangent);
...
//-----------------------------------------------------------------------------
void CDmeMesh::DrawWireframeFaceSet(CDmeFaceSet *pFaceSet,
  ...
  const FieldIndex_t posField =
      pBind->FindFieldIndex(CDmeVertexData::FIELD_POSITION);
  if (posField < 0) return;

  const CUtlVector<Vector> &posData(
      CDmrArrayConst<Vector>(pBind->GetVertexData(posField)).Get());
  const int nVertices = posData.Count();

  const CUtlVector<int> &posIndices(
      CDmrArrayConst<int>(pBind->GetIndexData(posField)).Get());

  Vector *pDeltaVertices = bHasActiveDeltaStates
                               ? pDeltaVertices = reinterpret_cast<Vector *>(
                                     alloca(nVertices * sizeof(Vector)))
                               : NULL;
  ...
  if (bHasActiveDeltaStates) {
    ...
    const FieldIndex_t nBalanceFieldIndex =
        pBind->FindFieldIndex(CDmeVertexDeltaData::FIELD_BALANCE);
    const FieldIndex_t nSpeedFieldIndex =
        pBind->FindFieldIndex(CDmeVertexDeltaData::FIELD_MORPH_SPEED);
    const bool bDoLag = (nSpeedFieldIndex >= 0);
    ...
    if (nBalanceFieldIndex < 0) {
      for (int i = 0; i < nCount; ++i) {
        ...
        float flLaggedWeight =
            m_DeltaStateWeights[MESH_DELTA_WEIGHT_LAGGED][i].x;
        if (flWeight <= 0.0f && (!bDoLag || flLaggedWeight <= 0.0f)) continue;

        AddVertexDelta<Vector>(pBind, pDeltaVertices, sizeof(Vector),
                               CDmeVertexDeltaData::FIELD_POSITION, i, bDoLag);
      }
    } else {
      for (int i = 0; i < nCount; ++i) {
        float flLeftWeight = m_DeltaStateWeights[MESH_DELTA_WEIGHT_NORMAL][i].x;
        float flRightWeight =
            m_DeltaStateWeights[MESH_DELTA_WEIGHT_NORMAL][i].y;
        float flLeftWeightLagged =
            m_DeltaStateWeights[MESH_DELTA_WEIGHT_LAGGED][i].x;
        float flRightWeightLagged =
            m_DeltaStateWeights[MESH_DELTA_WEIGHT_LAGGED][i].y;
        ...
        AddStereoVertexDelta<Vector>(pBind, pDeltaVertices, sizeof(Vector),
                                     CDmeVertexDeltaData::FIELD_POSITION, i,
                                     bDoLag);
      }
    }
  ...
  Vector *pVertices =
      reinterpret_cast<Vector *>(alloca(nVertices * sizeof(Vector)));
...
bool CDmeMesh::HasActiveDeltaStates() const {
  for (int t = 0; t < MESH_DELTA_WEIGHT_TYPE_COUNT; ++t) {
    ...
    for (int i = 0; i < nCount; ++i) {
      if (m_DeltaStateWeights[t][i].x != 0.0f ||
          m_DeltaStateWeights[t][i].y != 0.0f)
        return true;
    }
  }
...
// Draws the mesh
//-----------------------------------------------------------------------------
void CDmeMesh::Draw(const matrix3x4_t &shapeToWorld,
                    CDmeDrawSettings *pDrawSettings /* = NULL */) {
  ...
  const CDmeDrawSettings::DrawType_t drawType =
      pDrawSettings ? pDrawSettings->GetDrawType()
                    : CDmeDrawSettings::DRAW_SMOOTH;

  const bool bShaded = (drawType == CDmeDrawSettings::DRAW_SMOOTH ||
                        drawType == CDmeDrawSettings::DRAW_FLAT);
  const bool bWireframe = (drawType == CDmeDrawSettings::DRAW_WIREFRAME);
  //	const bool bBoundingBox = ( drawType ==
  // CDmeDrawSettings::DRAW_BOUNDINGBOX );

  const bool bSoftwareSkinning =
      bHasActiveDeltaStates | bDrawNormals | bWireframe;

  matrix3x4_t *pPoseToWorld = CDmeModel::SetupModelRenderState(
      shapeToWorld, pBind->HasSkinningData(), bSoftwareSkinning);
  ...
  const bool bindMaterial =
      pDrawSettings ? !pDrawSettings->IsAMaterialBound() : true;
  ...
  for (int fi = 0; fi < nFaceSets; ++fi) {
    ...
    if (pPoseToWorld || (bShaded && bSoftwareSkinning)) {
      DrawDynamicMesh(pFaceSet, pPoseToWorld, bHasActiveDeltaStates,
                      pDrawSettings);
      continue;
    }
...
CDmeVertexData *CDmeMesh::FindBaseState(const char *pStateName) const {
  ...
  for (int i = 0; i < nBaseStateCount; ++i) {
    ...
    if (!Q_stricmp(pStateName, pBaseState->GetName())) return pBaseState;
  }
...
CDmeVertexData *CDmeMesh::FindOrCreateBaseState(const char *pStateName) {
  ...
  if (pBaseState) return pBaseState;
...
bool CDmeMesh::SetBindBaseState(CDmeVertexData *pBaseState) {
  if (!pBaseState) return false;

  CDmeVertexData *pCheckState = FindBaseState(pBaseState->GetName());
  if (pCheckState != pBaseState) return false;
...
CDmeVertexData *CDmeMesh::GetBindBaseState() {
  if (m_BindBaseState.GetElement()) return m_BindBaseState;
...
CDmeVertexDeltaData *CDmeMesh::GetDeltaState(int nDeltaIndex) const {
  if (nDeltaIndex < 0 || nDeltaIndex >= m_DeltaStates.Count()) return NULL;
...
// If the name doe
//-----------------------------------------------------------------------------
const char *SortDeltaName(const char *pInDeltaName, char *pOutDeltaName,
...
//
//-----------------------------------------------------------------------------
CDmeVertexDeltaData *CDmeMesh::FindOrCreateDeltaState(
    const char *pInDeltaName) {
...
//
//-----------------------------------------------------------------------------
void CDmeMesh::SetDeltaStateWeight(int nDeltaIndex, MeshDeltaWeightType_t type,
                                   float flMorphWeight) {
  if (nDeltaIndex < m_DeltaStateWeights[type].Count()) {
    m_DeltaStateWeights[type].Set(nDeltaIndex,
                                  Vector2D(flMorphWeight, flMorphWeight));
  }
}
...
//-----------------------------------------------------------------------------
void CDmeMesh::SetDeltaStateWeight(int nDeltaIndex, MeshDeltaWeightType_t type,
                                   float flLeftWeight, float flRightWeight) {
  if (nDeltaIndex < m_DeltaStateWeights[type].Count()) {
    m_DeltaStateWeights[type].Set(nDeltaIndex,
                                  Vector2D(flLeftWeight, flRightWeight));
  }
}
...
IMesh *CDmeMesh::CreateHwMesh(CDmeFaceSet *pFaceSet) {
  ...
  // Mostly chose to do this for code simplicity, although it also is faster to
  // generate meshes
  CMatRenderContextPtr pRenderContext(g_pMaterialSystem);
  ...
  FieldIndex_t normalField =
      pBind->FindFieldIndex(CDmeVertexData::FIELD_NORMAL);
  FieldIndex_t tangentField =
      pBind->FindFieldIndex(CDmeVertexData::FIELD_TANGENT);
  ...
  const CDmrArrayConst<int> pNormalIndices =
      bHasNormals ? pBind->GetIndexData(normalField) : NULL;
  const CDmrArrayConst<Vector> pNormalData =
      bHasNormals ? pBind->GetVertexData(normalField) : NULL;
  const CDmrArrayConst<int> pTangentIndices =
      bHasTangent ? pBind->GetIndexData(tangentField) : NULL;
  const CDmrArrayConst<Vector4D> pTangentData =
      bHasTangent ? pBind->GetVertexData(tangentField) : NULL;
  const CDmrArrayConst<int> pUVIndices =
      bHasTexCoords ? pBind->GetIndexData(uvField) : NULL;
  const CDmrArrayConst<Vector2D> pUVData =
      bHasTexCoords ? pBind->GetVertexData(uvField) : NULL;
  const CDmrArrayConst<int> pColorIndices =
      bHasColors ? pBind->GetIndexData(colorField) : NULL;
  const CDmrArrayConst<Color> pColorData =
      bHasColors ? pBind->GetVertexData(colorField) : NULL;
  ...
  while (nFirstIndex < nIndexCount) {
    ...
    if (nVertexCount >= 3) {
      int nOutCount = (nVertexCount - 2) * 3;
      int *pIndices = (int *)_alloca(nOutCount * sizeof(int));
      ComputeTriangulatedIndices(pBind, pFaceSet, nFirstIndex, pIndices,
                                 nOutCount);
      for (int ii = 0; ii < nOutCount; ++ii) {
        meshBuilder.FastIndex(pIndices[ii]);
      }
...
//-----------------------------------------------------------------------------
void CDmeMesh::ComputeTriangulatedIndices(const CDmeVertexData *pBaseState,
                                          CDmeFaceSet *pFaceSet,
  ...
  for (int i = 0; i < nLoopCount; ++i) {
    ...
    const Vector &vecCenter =
        pBaseState->GetPosition(pFaceSet->GetIndex(nFirstIndex + i));
    for (int j = 2; j < nVertexCount - 1; ++j) {
      int vi = (i + j) % nVertexCount;
      const Vector &vecEdge =
          pBaseState->GetPosition(pFaceSet->GetIndex(nFirstIndex + vi));
  ...
  for (int i = 1; i < nVertexCount - 1; ++i) {
    ...
    pIndices[nOutIndex++] =
        pFaceSet->GetIndex(nFirstIndex + ((nMinIndex + i) % nVertexCount));
    pIndices[nOutIndex++] =
        pFaceSet->GetIndex(nFirstIndex + ((nMinIndex + i + 1) % nVertexCount));
  }
}
...
//-----------------------------------------------------------------------------
void CDmeMesh::BuildTriangleMap(const CDmeVertexData *pBaseState,
                                CDmeFaceSet *pFaceSet,
                                CUtlVector<Triangle_t> &triangles,
                                CUtlVector<CUtlVector<int> > *pVertToTriMap) {
  // prepare indices
  int nFirstIndex = 0;
  int nIndexCount = pFaceSet->NumIndices();
  while (nFirstIndex < nIndexCount) {
...
//-----------------------------------------------------------------------------
void CDmeMesh::ComputeTriangleTangets(const CDmeVertexData *pVertexData,
                                      CUtlVector<Triangle_t> &triangles) {
  ...
  for (int triID = 0; triID < nTriangleCount; triID++) {
    ...
    CalcTriangleTangentSpace(p0, p1, p2, t0, t1, t2, triangle.m_vecTangentS,
                             triangle.m_vecTangentT);
  }
}
...
// Build a map from vertex index to a list of triangles that share the vert.
//-----------------------------------------------------------------------------
void CDmeMesh::ComputeAverageTangent(CDmeVertexData *pVertexData,
                                     bool bSmoothTangents,
                                     CUtlVector<CUtlVector<int> > &vertToTriMap,
                                     CUtlVector<Triangle_t> &triangles) {
  FieldIndex_t posField =
      pVertexData->FindFieldIndex(CDmeVertexData::FIELD_POSITION);
  FieldIndex_t normalField =
      pVertexData->FindFieldIndex(CDmeVertexData::FIELD_NORMAL);
  FieldIndex_t tangentField =
      pVertexData->FindFieldIndex(CDmeVertexData::FIELD_TANGENT);
  ...
  for (int vertID = 0; vertID < nVertexCount; vertID++) {
    ...
    if (bSmoothTangents) {
      ...
      for (int vertID2 = 0; vertID2 < nVertexCount; vertID2++) {
        if (vertID2 == vertID) continue;

        const Vector &vertPos2 =
            pPositionData.Get(pPositionIndices.Get(vertID2));
    ...
    pVertexData->SetVertexData(tangentField, vertID, 1, AT_VECTOR4,
                               &finalSVect);
...
//-----------------------------------------------------------------------------
void CDmeMesh::BuildVertToTriMap(const CDmeVertexData *pVertexData,
                                 CUtlVector<Triangle_t> &triangles,
                                 CUtlVector<CUtlVector<int> > &vertToTriMap) {
...
//-----------------------------------------------------------------------------
void CDmeMesh::ComputeDefaultTangentData(CDmeVertexData *pVertexData,
                                         bool bSmoothTangents) {
  if (!pVertexData) return;
...
//-----------------------------------------------------------------------------
// Compute a default per-vertex tangent given normal data + uv data for all
// vertex data referenced by this mesh
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
// Utility method to compute default tangent data on all meshes in the sub-dag
// hierarchy
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
// Computes the aggregate position for all vertices after applying a set of
// delta states
//-----------------------------------------------------------------------------
void CDmeMesh::AddDelta(CDmeVertexData *pBaseState, Vector *pDeltaPosition,
                        int nDeltaStateIndex,
                        CDmeVertexData::StandardFields_t fieldId) {
  ...
  if (pBaseState->FindFieldIndex(CDmeVertexData::FIELD_BALANCE) != -1) {
    AddStereoVertexDelta<Vector>(pBaseState, pDeltaPosition, sizeof(Vector),
                                 fieldId, nDeltaStateIndex, true);
  } else {
    AddVertexDelta<Vector>(pBaseState, pDeltaPosition, sizeof(Vector), fieldId,
                           nDeltaStateIndex, true);
  }
}
...
void CDmeMesh::ComputeNormalsFromPositions(
    CDmeVertexData *pBase, const Vector *pPosition,
    const CUtlVector<Triangle_t> &triangles, int nNormalCount,
    Vector *pNormals) {
  ...
  const CUtlVector<int> &positionIndices =
      pBase->GetVertexIndexData(CDmeVertexData::FIELD_POSITION);
  const CUtlVector<int> &normalIndices =
      pBase->GetVertexIndexData(CDmeVertexData::FIELD_NORMAL);
...
//-----------------------------------------------------------------------------
// Converts pose-space normals into deltas appropriate for correction delta
// states
//-----------------------------------------------------------------------------
void CDmeMesh::ComputeCorrectedNormalsFromActualNormals(
    const CUtlVector<int> &deltaStateList, int nNormalCount, Vector *pNormals) {
  CDmeVertexData *pBind = GetBindBaseState();
  if (!pBind) return;
  ...
  Vector *pUncorrectedNormals =
      (Vector *)_alloca(nNormalCount * sizeof(Vector));
  memcpy(pUncorrectedNormals, pBind->GetNormalData().Base(),
         nNormalCount * sizeof(Vector));
  int nDeltaStateCount = deltaStateList.Count();
  for (int i = 0; i < nDeltaStateCount; ++i) {
    AddDelta(pBind, pUncorrectedNormals, deltaStateList[i],
...
//-----------------------------------------------------------------------------
void CDmeMesh::SetDeltaNormalData(int nDeltaIndex, int nNormalCount,
                                  Vector *pNormals) {
  // pNormals represents the correct normal delta state for this combination
  // Copy it into the delta state for this combination.
  // Use tolerance to deal with precision errors introduced by the various
  // computations
  CDmeVertexDeltaData *pDeltaState = GetDeltaState(nDeltaIndex);
  FieldIndex_t nNormalField =
      pDeltaState->FindFieldIndex(CDmeVertexDeltaData::FIELD_NORMAL);
  if (nNormalField >= 0) {
  ...
  for (int i = 0; i < nNormalCount; ++i) {
    if (pNormals[i].LengthSqr() < 1e-4) continue;

    int nNormalIndex = pDeltaState->AddVertexData(nNormalField, 1);
    pDeltaState->SetVertexData(nNormalField, nNormalIndex, 1, AT_VECTOR3,
                               &pNormals[i]);
...
//
//-----------------------------------------------------------------------------
void CDmeMesh::BuildAtomicControlLists(
    int nCount, DeltaComputation_t *pInfo,
  ...
  for (nCurrentDelta = 0; nCurrentDelta < nCount; ++nCurrentDelta) {
    if (pInfo[nCurrentDelta].m_nDimensionality != 1) break;
    int j = atomicControls.AddToTail(
        GetDeltaState(pInfo[nCurrentDelta].m_nDeltaIndex)->GetName());
    deltaStateUsage[nCurrentDelta].AddToTail(j);
  }

  for (; nCurrentDelta < nCount; ++nCurrentDelta) {
    CDmeVertexDeltaData *pDeltaState =
        GetDeltaState(pInfo[nCurrentDelta].m_nDeltaIndex);
    ...
    for (char *pUnderBar = pTempBuf; pUnderBar; pUnderBar = pNext) {
      ...
      for (j = 0; j < nControlCount; ++j) {
        if (!Q_stricmp(pUnderBar, atomicControls[j])) break;
      }
      if (j == nControlCount) {
...
//-----------------------------------------------------------------------------
void CDmeMesh::ComputeDependentDeltaStateList(
...
// NOTE: This assumes a naming scheme where delta state names have _ that
// separate control names
//-----------------------------------------------------------------------------
void CDmeMesh::ComputeDeltaStateComputationList(
    CUtlVector<DeltaComputation_t> &compList) {
  ...
  qsort(compList.Base(), nCount, sizeof(DeltaComputation_t),
        DeltaStateLessFunc);
}
...
void CDmeMesh::ComputeDeltaStateNormals() {
  ...
  const FieldIndex_t nBindNormalIndex =
      pBind->CreateField(CDmeVertexData::FIELD_NORMAL);
  ...
  Vector *pNormals =
      reinterpret_cast<Vector *>(alloca(nPosCount * sizeof(Vector)));

  // Make all of the normals in the bind pose smooth
  {
    const CUtlVector<int> &basePosIndices =
        pBind->GetVertexIndexData(CDmeVertexData::FIELD_POSITION);

    pBind->SetVertexIndices(nBindNormalIndex, 0, basePosIndices.Count(),
                            basePosIndices.Base());
    pBind->RemoveAllVertexData(nBindNormalIndex);
    pBind->AddVertexData(nBindNormalIndex, nPosCount);

    ComputeNormalsFromPositions(pBind, basePosData.Base(), triangles, nPosCount,
                                pNormals);
    ...
    if (pCurrent != pBind) {
      const FieldIndex_t nCurrentNormalIndex =
          pCurrent->CreateField(CDmeVertexData::FIELD_NORMAL);
      pCurrent->SetVertexIndices(nCurrentNormalIndex, 0, basePosIndices.Count(),
                                 basePosIndices.Base());
      ...
      ComputeNormalsFromPositions(pCurrent, currPosData.Base(), triangles,
                                  nPosCount, pNormals);
      pCurrent->SetVertexData(nCurrentNormalIndex, 0, nPosCount, AT_VECTOR3,
                              pNormals);
    }
  }
  ...
  for (int i = 0; i < nDeltaStateCount; ++i) {
    ...
    for (int j = 0; j < nDepStateCount; ++j) {
      AddDelta(GetDeltaState(depDeltas[j]), pPosData, nPosCount,
               CDmeVertexData::FIELD_POSITION);
    }

    AddDelta(GetDeltaState(deltaComputation.m_nDeltaIndex), pPosData, nPosCount,
             CDmeVertexData::FIELD_POSITION);

    ComputeNormalsFromPositions(pBind, pPosData, triangles, nPosCount,
                                pNormals);

    SetDeltaNormalDataFromActualNormals(computationOrder[i].m_nDeltaIndex,
                                        depDeltas, nPosCount, pNormals);
  }
}
...
// separate control names
//-----------------------------------------------------------------------------
void CDmeMesh::SetDeltaNormalDataFromActualNormals(
    int nDeltaIndex, const CUtlVector<int> &deltaStateList, int nNormalCount,
    Vector *pNormals) {
  ...
  ComputeCorrectedNormalsFromActualNormals(deltaStateList, nNormalCount,
                                           pNormals);
...
//-----------------------------------------------------------------------------
void CDmeMesh::Combinations(int n, int k, CUtlVector<CUtlVector<int> > &combos,
                            int *pTmpArray, int start, int currentK) {
  if (!pTmpArray) {
...
//-----------------------------------------------------------------------------
bool CDmeMesh::GetControlDeltaIndices(
    const char *pDeltaStateName, CUtlVector<int> &controlDeltaIndices) const {
...
bool CDmeMesh::BuildCompleteDeltaStateControlList(
  ...
  for (int i = 0; i < nDeltas; ++i) {
    ...
    deltaStateControlList[deltaStateControlList.AddToTail()].CopyArray(
        tmpControlDeltaIndices.Base(), tmpControlDeltaIndices.Count());
  }
...
bool CDmeMesh::BuildMissingDependentDeltaList(
    CDmeVertexDeltaData *pDeltaState, CUtlVector<int> &controlIndices,
  ...
  for (int i(nControlIndices - 1); i > 0; --i) {
    ...
    for (int j(0); j < nCombos; ++j) {
      ...
      if (comboIndices.Count()) {
        ...
        if (FindDeltaIndexFromControlIndices(comboControls,
                                             deltaStateControlList) < 0) {
          dependentStates[dependentStates.AddToTail()].CopyArray(
              comboControls.Base(), comboControls.Count());
        }
      }
    }
  }
...
int CDmeMesh::GenerateCompleteDataForDelta(
    const CDmeVertexDeltaData *pDelta, T_t *pFullData, int nFullData,
...
//-----------------------------------------------------------------------------
template <class T_t>
void CDmeMesh::AddDelta(const CDmeVertexDeltaData *pDelta, T_t *pFullData,
                        int nFullData, FieldIndex_t fieldIndex, float weight,
...
template void CDmeMesh::AddDelta<float>(const CDmeVertexDeltaData *, float *,
                                        int, FieldIndex_t, float,
                                        const CDmeSingleIndexedComponent *);
template void CDmeMesh::AddDelta<Vector2D>(const CDmeVertexDeltaData *,
                                           Vector2D *, int, FieldIndex_t, float,
                                           const CDmeSingleIndexedComponent *);
template void CDmeMesh::AddDelta<Vector>(const CDmeVertexDeltaData *, Vector *,
                                         int, FieldIndex_t, float,
                                         const CDmeSingleIndexedComponent *);
...
void CDmeMesh::AddDelta(const CDmeVertexDeltaData *pDelta, T_t *pFullData,
                        int nFullData,
                        CDmeVertexData::StandardFields_t standardField,
                        float weight, const CDmeSingleIndexedComponent *pMask) {
  const FieldIndex_t fIndex(pDelta->FindFieldIndex(standardField));
  AddDelta(pDelta, pFullData, nFullData, fIndex, weight, pMask);
}

template void CDmeMesh::AddDelta<float>(const CDmeVertexDeltaData *, float *,
                                        int, CDmeVertexData::StandardFields_t,
                                        float,
                                        const CDmeSingleIndexedComponent *);
template void CDmeMesh::AddDelta<Vector2D>(const CDmeVertexDeltaData *,
                                           Vector2D *, int,
...
void CDmeMesh::ComputeAllCorrectedPositionsFromActualPositions() {
  ...
  Vector *pPositions(
      reinterpret_cast<Vector *>(alloca(nPositions * sizeof(Vector))));
  ...
  for (int i = 0; i < nDeltas; ++i) {
    ...
    if (!pDelta->GetValue<bool>("corrected")) {
      const FieldIndex_t pIndex(
          pDelta->FindFieldIndex(CDmeVertexDeltaData::FIELD_POSITION));
      if (pIndex < 0) continue;

      GenerateCompleteDataForDelta(pDelta, pPositions, nPositions,
                                   CDmeVertexData::FIELD_POSITION);

      const CUtlVector<int> &dependentDeltas(
          deltaComputation.m_DependentDeltas);
      const int nDependentDeltas(dependentDeltas.Count());
      for (int j(0); j < nDependentDeltas; ++j) {
        const CDmeVertexDeltaData *pDependentDelta(
            m_DeltaStates[dependentDeltas[j]]);
        const CUtlVector<Vector> &dPositions(
            pDependentDelta->GetPositionData());
        const CUtlVector<int> &dIndices(pDependentDelta->GetVertexIndexData(
            CDmeVertexData::FIELD_POSITION));
      ...
      for (int j(0); j < nPositions; ++j) {
        ...
        // Kind of a magic number but it's because of 16 bit compression of the
        // delta values
...
//-----------------------------------------------------------------------------
template <class T_t>
void CDmeMesh::AddCorrectedDelta(CDmrArray<T_t> &baseDataArray,
                                 const CUtlVector<int> &baseIndices,
                                 const DeltaComputation_t &deltaComputation,
                                 const char *pFieldName, float weight,
                                 const CDmeSingleIndexedComponent *pMask) {
...
//-----------------------------------------------------------------------------
template <class T_t>
void CDmeMesh::AddCorrectedDelta(CUtlVector<T_t> &baseData,
                                 const CUtlVector<int> &baseIndices,
                                 const DeltaComputation_t &deltaComputation,
                                 const char *pFieldName, float weight,
                                 const CDmeSingleIndexedComponent *pMask) {
...
//-----------------------------------------------------------------------------
template <class T_t>
void CDmeMesh::AddRawDelta(CDmeVertexDeltaData *pDelta,
                           CDmrArray<T_t> &baseDataArray,
                           FieldIndex_t nDeltaFieldIndex, float weight,
                           const CDmeSingleIndexedComponent *pMask) {
  if (!pDelta || nDeltaFieldIndex < 0) return;
...
//-----------------------------------------------------------------------------
bool CDmeMesh::SetBaseStateToDelta(const CDmeVertexDeltaData *pDelta,
  ...
  for (int i = 0; i < nDeltas; ++i) {
    if (pDelta != GetDeltaState(compList[i].m_nDeltaIndex)) continue;
    ...
    for (int j(0); j < nBaseField; ++j) {
      ...
      for (int k(0); k < nDeltaField; ++k) {
        ...
        const FieldIndex_t deltaFieldIndex(
            pDelta->FindFieldIndex(deltaFieldName));
        if (baseFieldIndex < 0 || deltaFieldIndex < 0) break;
        ...
        const CUtlVector<int> &baseIndices(
            pBase->GetVertexIndexData(baseFieldIndex));

        switch (pBaseData->GetType()) {
          case AT_FLOAT_ARRAY:
            AddCorrectedDelta(CDmrArray<float>(pBaseData), baseIndices,
                              compList[i], baseFieldName);
            break;
          case AT_COLOR_ARRAY:
            AddCorrectedDelta(CDmrArray<Vector>(pBaseData), baseIndices,
                              compList[i], baseFieldName);
            break;
          case AT_VECTOR2_ARRAY:
            AddCorrectedDelta(CDmrArray<Vector2D>(pBaseData), baseIndices,
                              compList[i], baseFieldName);
            break;
...
//
//-----------------------------------------------------------------------------
void CDmeMesh::SelectVerticesFromDelta(CDmeVertexDeltaData *pDelta,
  ...
  const FieldIndex_t pField(
      pDelta->FindFieldIndex(CDmeVertexData::FIELD_POSITION));
  if (pField < 0) return;

  const CUtlVector<int> &pIndicies(
      pDelta->GetVertexIndexData(CDmeVertexData::FIELD_POSITION));
...
//
//-----------------------------------------------------------------------------
void CDmeMesh::SelectAllVertices(CDmeSingleIndexedComponent *pSelection,
                                 CDmeVertexData *pPassedBase /* = NULL */) {
  const CDmeVertexData *pBase =
      pPassedBase ? pPassedBase : GetCurrentBaseState();
  ...
  const FieldIndex_t pField(
      pBase->FindFieldIndex(CDmeVertexData::FIELD_POSITION));
  if (pField < 0) return;

  CUtlVector<int> indices;
  indices.EnsureCount(
      CDmrArrayConst<Vector>(pBase->GetVertexData(pField)).Count());
...
//
//-----------------------------------------------------------------------------
void CDmeMesh::SelectHalfVertices(SelectHalfType_t selectHalfType,
                                  CDmeSingleIndexedComponent *pSelection,
                                  CDmeVertexData *pPassedBase /* = NULL */) {
  const CDmeVertexData *pBase =
      pPassedBase ? pPassedBase : GetCurrentBaseState();
...
bool CDmeMesh::CreateDeltaFieldFromBaseField(
    ...
    const CDmrArrayConst<float> &bindArray, CDmeVertexDeltaData *pDelta) {
  const int nData(baseArray.Count());
  if (nData != bindArray.Count()) return false;
...
bool CDmeMesh::CreateDeltaFieldFromBaseField(
    ...
    const CDmrArrayConst<Vector2D> &bindArray, CDmeVertexDeltaData *pDelta) {
  const int nData(baseArray.Count());
  if (nData != bindArray.Count()) return false;
...
bool CDmeMesh::CreateDeltaFieldFromBaseField(
    ...
    const CDmrArrayConst<Vector> &bindArray, CDmeVertexDeltaData *pDelta) {
  const int nData(baseArray.Count());
  if (nData != bindArray.Count()) return false;
...
//-----------------------------------------------------------------------------
CDmeVertexDeltaData *CDmeMesh::ModifyOrCreateDeltaStateFromBaseState(
    const char *pDeltaName, CDmeVertexData *pPassedBase /* = NULL */,
    bool absolute /* = false */) {
  ...
  if (nSuperior > 0) {
    ...
    for (int i = 0; i < nSuperior; ++i) {
      ...
      if (pSuperiorDelta->GetValue<bool>("corrected")) {
        ...
        if (!ModifyOrCreateDeltaStateFromBaseState(
                CUtlString(pSuperiorDelta->GetName()), pTmpBaseState, true))
          return NULL;
      }
    }
  ...
  if (!pDelta) return NULL;

  CDmeVertexData::StandardFields_t deltaFields[] = {
      CDmeVertexData::FIELD_POSITION, CDmeVertexData::FIELD_NORMAL,
  ...
  for (int i = 0; i < sizeof(deltaFields) / sizeof(deltaFields[0]); ++i) {
    ...
    const FieldIndex_t baseFieldIndex(
        pBase->FindFieldIndex(standardFieldIndex));
    const FieldIndex_t bindFieldIndex(
    ...
    switch (pBaseData->GetType()) {
      case AT_FLOAT_ARRAY:
        CreateDeltaFieldFromBaseField(standardFieldIndex,
                                      CDmrArrayConst<float>(pBaseData),
                                      CDmrArrayConst<float>(pBindData), pDelta);
        break;
      case AT_COLOR_ARRAY:
        CreateDeltaFieldFromBaseField(
            standardFieldIndex, CDmrArrayConst<Vector>(pBaseData),
            CDmrArrayConst<Vector>(pBindData), pDelta);
        break;
      case AT_VECTOR2_ARRAY:
        CreateDeltaFieldFromBaseField(
            standardFieldIndex, CDmrArrayConst<Vector2D>(pBaseData),
            CDmrArrayConst<Vector2D>(pBindData), pDelta);
        break;
      case AT_VECTOR3_ARRAY:
        CreateDeltaFieldFromBaseField(
            standardFieldIndex, CDmrArrayConst<Vector>(pBaseData),
  ...
  if (!strchr(pDelta->GetName(), '_')) {
    ...
    CDmeCombinationOperator *pCombo(
        FindReferringElement<CDmeCombinationOperator>(this, symTargets));
    if (pCombo) {
...
bool CDmeMesh::DeleteDeltaState(const char *pDeltaName) {
  ...
  if (nDeltaIndex < 0) return false;

  Assert(m_DeltaStates.Count() ==
         m_DeltaStateWeights[MESH_DELTA_WEIGHT_NORMAL].Count());
  Assert(m_DeltaStates.Count() ==
         m_DeltaStateWeights[MESH_DELTA_WEIGHT_LAGGED].Count());
  CDmeVertexDeltaData *pDelta(m_DeltaStates[nDeltaIndex]);
  if (!pDelta) return false;
...
bool CDmeMesh::ResetDeltaState(const char *pDeltaName) {
  ...
  CDmeVertexDeltaData *pNewDelta =
      CreateElement<CDmeVertexDeltaData>(pOldDelta->GetName(), GetFileId());
  if (!pNewDelta) return false;
...
class CSelectionHelper {
 public:
  ...
  int RemoveFromSelection(CDmeSingleIndexedComponent *pSelection,
...
//
//-----------------------------------------------------------------------------
int CSelectionHelper::AddToSelection(
    CDmeSingleIndexedComponent *pSelection) const {
  const int nVerts = m_verts.Count();

  for (int i = 0; i < nVerts; ++i) {
    const CVert &v(m_verts[i]);
    Assert(!pSelection->HasComponent(v.m_index));
    pSelection->AddComponent(v.m_index,
                             v.m_weight / static_cast<float>(v.m_count));
  }
...
//
//-----------------------------------------------------------------------------
int CSelectionHelper::RemoveFromSelection(
    CDmeSingleIndexedComponent *pSelection, bool bAllowEmpty) const {
  const int nVerts = m_verts.Count();
...
//
//-----------------------------------------------------------------------------
void CDmeMesh::GrowSelection(int nSize, CDmeSingleIndexedComponent *pSelection,
                             CDmMeshComp *pPassedMeshComp) {
  if (nSize <= 0 || !pSelection) return;
  ...
  CDmMeshComp *pMeshComp =
      pPassedMeshComp ? pPassedMeshComp : new CDmMeshComp(this);
  ...
  for (int i = 0; i < nVertices; ++i) {
    const int nNeighbours =
        pMeshComp->FindNeighbouringVerts(sIndices[i], neighbours);
...
//
//-----------------------------------------------------------------------------
void CDmeMesh::ShrinkSelection(int nSize,
                               CDmeSingleIndexedComponent *pSelection,
                               CDmMeshComp *pPassedMeshComp) {
  if (nSize <= 0 || !pSelection) return;
  ...
  for (int i = 0; i < nVertices; ++i) {
    ...
    const int nNeighbours =
        pMeshComp->FindNeighbouringVerts(vIndex, neighbours);
    for (int j = 0; j < nNeighbours; ++j) {
...
CDmeSingleIndexedComponent *CDmeMesh::FeatherSelection(
    float falloffDistance, Falloff_t falloffType, Distance_t distanceType,
    CDmeSingleIndexedComponent *pSelection, CDmMeshComp *pPassedMeshComp) {
  switch (falloffType) {
    case SMOOTH:
      return FeatherSelection<SMOOTH>(falloffDistance, distanceType, pSelection,
                                      pPassedMeshComp);
    case SPIKE:
      return FeatherSelection<SPIKE>(falloffDistance, distanceType, pSelection,
                                     pPassedMeshComp);
    case DOME:
      return FeatherSelection<DOME>(falloffDistance, distanceType, pSelection,
                                    pPassedMeshComp);
    default:
      return FeatherSelection<LINEAR>(falloffDistance, distanceType, pSelection,
                                      pPassedMeshComp);
  }
}
...
CDmeSingleIndexedComponent *CDmeMesh::FeatherSelection(
  ...
  CDmeSingleIndexedComponent *pNewSelection =
      CreateElement<CDmeSingleIndexedComponent>("feather",
                                                pSelection->GetFileId());
  ...
  do {
    ...
    for (int i = 0; i < nVertices; ++i) {
      ...
      for (int j = 0; j < nNeighbours; ++j) {
        ...
        const int closestVert =
            ClosestSelectedVertex(vIndex, pSelection, pBase);
        if (closestVert < 0 || closestVert >= nPositions) continue;

        const float vDistance =
            positions[vIndex].DistTo(positions[closestVert]);
...
bool CDmeMesh::AddMaskedDelta(
    CDmeVertexDeltaData *pDelta, CDmeVertexData *pDst /* = NULL */,
    float weight /* = 1.0f */,
  ...
  for (int j(0); j < nBaseField; ++j) {
    ...
    for (int k(0); k < nDeltaField; ++k) {
      ...
      switch (pBaseData->GetType()) {
        case AT_FLOAT_ARRAY:
          AddRawDelta(pDelta, CDmrArray<float>(pBaseData), baseFieldIndex,
                      weight, pMask);
          break;
        case AT_COLOR_ARRAY:
          // TODO: Color is missing some algebraic operators
          //				AddRawDelta( pDelta, CDmrArray< Color >(
          // pBaseData
          //), baseFieldIndex, weight, pMask );
          break;
        case AT_VECTOR2_ARRAY:
          AddRawDelta(pDelta, CDmrArray<Vector2D>(pBaseData), baseFieldIndex,
                      weight, pMask);
          break;
        case AT_VECTOR3_ARRAY:
          AddRawDelta(pDelta, CDmrArray<Vector>(pBaseData), baseFieldIndex,
                      weight, pMask);
          break;
        default:
          break;
...
//-----------------------------------------------------------------------------
template <class T_t>
bool CDmeMesh::InterpMaskedData(CDmrArray<T_t> &aData,
                                const CUtlVector<T_t> &bData, float weight,
                                const CDmeSingleIndexedComponent *pMask) const {
  const int nDst = aData.Count();

  if (bData.Count() != nDst) return false;

  // The wacky way of writing these expression is because Vector4D is missing
  // operators And this probably works better because of fewer temporaries
...
//-----------------------------------------------------------------------------
bool CDmeMesh::InterpMaskedData(CDmeVertexData *paData,
                                const CDmeVertexData *pbData, float weight,
                                const CDmeSingleIndexedComponent *pMask) const {
  if (!paData || !pbData || paData == pbData) return false;
  ...
  for (int i = 0; i < naField; ++i) {
    ...
    for (int j = 0; j < nbField; ++j) {
      ...
      if (aFieldName != bFieldName) continue;
      ...
      if (paData->GetVertexIndexData(aFieldIndex).Count() !=
          pbData->GetVertexIndexData(bFieldIndex).Count())
        break;

      switch (paAttr->GetType()) {
        case AT_FLOAT_ARRAY: {
          CDmrArray<float> f{paAttr};
          InterpMaskedData(f, CDmrArrayConst<float>(pbAttr).Get(), weight,
                           pMask);
          break;
        }
        case AT_COLOR_ARRAY: {
          CDmrArray<Vector4D> c{paAttr};
          InterpMaskedData(c, CDmrArrayConst<Vector4D>(pbAttr).Get(), weight,
                           pMask);
          break;
        }
        case AT_VECTOR2_ARRAY: {
          CDmrArray<Vector2D> v2{paAttr};
          InterpMaskedData(v2, CDmrArrayConst<Vector2D>(pbAttr).Get(), weight,
                           pMask);
          break;
        }
        case AT_VECTOR3_ARRAY: {
          CDmrArray<Vector> v3{paAttr};
          InterpMaskedData(v3, CDmrArrayConst<Vector>(pbAttr).Get(), weight,
                           pMask);
          break;
        }
        default:
  ...
  for (int i = 0; i < nDeltas; ++i) {
    ...
    for (int j(0); j < nBaseField; ++j) {
      ...
      for (int k = 0; k < nBindField; ++k) {
        ...
        if (baseFieldName != bindFieldName) continue;

        for (int l = 0; l < nDeltaField; ++l) {
          const CUtlString &deltaFieldName(pDelta->FieldName(l));
          if (bindFieldName != deltaFieldName) continue;

          const FieldIndex_t baseFieldIndex(
              pDstBase->FindFieldIndex(baseFieldName));
          const FieldIndex_t bindFieldIndex(
              pBind->FindFieldIndex(bindFieldName));
          const FieldIndex_t deltaFieldIndex(
              pDelta->FindFieldIndex(deltaFieldName));
          ...
          if (pDstBaseData->GetType() != pBindData->GetType() ||
              pBindData->GetType() != pDeltaData->GetType())
            break;

          const CUtlVector<int> &bindIndices(
              pBind->GetVertexIndexData(bindFieldIndex));

          switch (pDstBaseData->GetType()) {
            case AT_FLOAT_ARRAY:
              floatData = CDmrArrayConst<float>(pBindData).Get();
              AddCorrectedDelta(floatData, bindIndices, compList[i],
                                baseFieldName);
              InterpMaskedData(CDmrArray<float>(pDstBaseData), floatData,
                               weight, pMask);
              break;
            case AT_COLOR_ARRAY:
              vector4DData = CDmrArrayConst<Vector4D>(pBindData).Get();
              AddCorrectedDelta(vector4DData, bindIndices, compList[i],
                                baseFieldName);
              InterpMaskedData(CDmrArray<Vector4D>(pDstBaseData), vector4DData,
                               weight, pMask);
              break;
            case AT_VECTOR2_ARRAY:
              vector2DData = CDmrArrayConst<Vector2D>(pBindData).Get();
              AddCorrectedDelta(vector2DData, bindIndices, compList[i],
                                baseFieldName);
              InterpMaskedData(CDmrArray<Vector2D>(pDstBaseData), vector2DData,
                               weight, pMask);
              break;
            case AT_VECTOR3_ARRAY:
              vectorData = CDmrArrayConst<Vector>(pBindData).Get();
              AddCorrectedDelta(vectorData, bindIndices, compList[i],
                                baseFieldName);
              InterpMaskedData(CDmrArray<Vector>(pDstBaseData), vectorData,
                               weight, pMask);
              break;
            default:
              break;
...
// -1 on failure
//-----------------------------------------------------------------------------
int CDmeMesh::ClosestSelectedVertex(
    int vIndex, CDmeSingleIndexedComponent *pSelection,
    const CDmeVertexData *pPassedBase /* = NULL */) const {
  const CDmeVertexData *pBase =
      pPassedBase ? pPassedBase : GetCurrentBaseState();
  if (!pBase) return -1;
...
//
//-----------------------------------------------------------------------------
float CDmeMesh::DistanceBetween(
    int vIndex0, int vIndex1,
    const CDmeVertexData *pPassedBase /*= NULL */) const {
  const CDmeVertexData *pBase =
      pPassedBase ? pPassedBase : GetCurrentBaseState();
  if (!pBase) return 0.0f;
...
// by the control deltas, if any control delta doesn't exist it will return
// false.
//
...
// A_B_C
//-----------------------------------------------------------------------------
bool CDmeMesh::ComputeSuperiorDeltaStateList(
    const char *pInferiorDeltaName, CUtlVector<int> &superiorDeltaStates) {
  // TODO: Compute this data only when the deltas are added, removed or renamed
  CUtlVector<DeltaComputation_t> compList;
  ComputeDeltaStateComputationList(compList);

  // Typically the passed delta won't be in the list yet, but it could be,
  // that's ok Treat it like it isn't to be sure.
  ...
  qsort(inferiorIndices.Base(), nInferiorIndices, sizeof(int),
        ControlIndexLessFunc);
  ...
  for (int i = compList.Count() - 1; i >= 0; --i) {
    ...
    // For a delta to be superior, it has to have more control inputs than the
    // specified delta compList is sorted in order of dimensionality, so safe to
    // abort
    if (nInferiorIndices >= deltaComp.m_nDimensionality) break;

    pSuperiorDelta = GetDeltaState(deltaComp.m_nDeltaIndex);
    if (!pSuperiorDelta) continue;

    if (!GetControlDeltaIndices(pSuperiorDelta, superiorIndices)) continue;

    nSuperiorIndices = superiorIndices.Count();

    qsort(superiorIndices.Base(), nSuperiorIndices, sizeof(int),
          ControlIndexLessFunc);
...
void CDmeMesh::GetBoundingSphere(
    Vector &c, float &r, CDmeVertexData *pPassedBase /* = NULL */,
    CDmeSingleIndexedComponent *pPassedSelection /* = NULL */) const {
  c.Zero();
  r = 0.0f;
  ...
  if (pPassedSelection) {
    ...
    float sqDist;
    for (int k = 0; k < nSelectionCount; ++k) {
...
//
//-----------------------------------------------------------------------------
void CDmeMesh::GetBoundingBox(
    Vector &min, Vector &max, CDmeVertexData *pPassedBase /* = NULL */,
    CDmeSingleIndexedComponent *pPassedSelection /* = NULL */) const {
  min.Zero();
  max.Zero();
...
bool CDmeMesh::SetBaseDataToDeltas(
    CDmeVertexData *pBase, CDmeVertexData::StandardFields_t nStandardField,
    CDmrArrayConst<T_t> &srcData, CDmrArray<T_t> &dstData, bool bDoStereo,
    bool bDoLag) {
  const int nDataCount = dstData.Count();
  if (srcData.Count() != nDataCount) return false;
  ...
  if (bDoStereo) {
    for (int i = 0; i < nCount; ++i) {
      ...
      AddStereoVertexDelta<T_t>(pBase, pData, sizeof(T_t), nStandardField, i,
                                bDoLag);
    }
  } else {
    for (int i = 0; i < nCount; ++i) {
      ...
      if (flWeight < 0.0f && (!bDoLag || flWeightLagged <= 0.0f)) continue;
...
bool CDmeMesh::SetBaseStateToDeltas(CDmeVertexData *pPassedBase /*= NULL */) {
  ...
  const bool bDoStereo =
      (pBind->FindFieldIndex(CDmeVertexDeltaData::FIELD_BALANCE) >= 0);
  ...
  for (int i = 0; i < sizeof(deltaFields) / sizeof(deltaFields[0]); ++i) {
    ...
    if (nSrcField < 0 || nDstField < 0) continue;
    ...
    switch (pDstAttr->GetType()) {
      case AT_FLOAT_ARRAY:
        SetBaseDataToDeltas(pBind, nStandardField,
                            CDmrArrayConst<float>(pSrcAttr),
                            CDmrArray<float>(pDstAttr), bDoStereo, false);
        break;
      case AT_VECTOR3_ARRAY:
        SetBaseDataToDeltas(pBind, nStandardField,
                            CDmrArrayConst<Vector>(pSrcAttr),
                            CDmrArray<Vector>(pDstAttr), bDoStereo, false);
        break;
      default:
        Assert(0);
        break;
