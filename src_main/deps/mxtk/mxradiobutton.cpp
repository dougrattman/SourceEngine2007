...
mxRadioButton::mxRadioButton(mxWindow *parent, int x, int y, int w, int h,
                             const char *label, int id, bool newGroup)
  ...
  if (newGroup) dwStyle |= WS_GROUP;

  void *handle = (void *)CreateWindowEx(0, "BUTTON", label, dwStyle, x, y, w, h,
                                        hwndParent, (HMENU)id,
