...
class mxMatSysWindow : public mxWindow {
 ...
 public:
  ...
  // CREATORS
  mxMatSysWindow(mxWindow *parent, int x, int y, int w, int h,
                 const char *label = 0, int style = 0);
  virtual ~mxMatSysWindow();

  // IMaterialSystem *Init( const char *szGamedir, const char *szMaterialSystem,
  // const char *szShader, const char *szProxy );
