...
mxMatSysWindow::mxMatSysWindow(mxWindow *parent, int x, int y, int w, int h,
...
int mxMatSysWindow::handleEvent(mxEvent *event) { return 0; }
...
int mxMatSysWindow::makeCurrent() { return 1; }

int mxMatSysWindow::swapBuffers() { return 0; }

void mxMatSysWindow::setDrawFunc(void (*func)(void)) { d_drawFunc = func; }
