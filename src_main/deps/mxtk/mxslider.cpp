...
mxSlider::mxSlider(mxWindow *parent, int x, int y, int w, int h, int id,
                   int style)
  ...
  void *handle = (void *)CreateWindowEx(0, TRACKBAR_CLASS, "", dwStyle, x, y, w,
                                        h, hwndParent, (HMENU)id,
