...
enum EGameCode {
  ...
  // system**) CZ CD-key SteamLocalUserIds have 	high32bits	= ( GameCode
  // <<
  // sc_uNumBitsSalesTerritory) | SalesTerritory 	low32bits	=
  // UniqueSerialNumber CZ CD-key Steam IDs will be displayed as
...
enum ESalesTerritory {
  // DoD 	first batch		 80,000	keys	**Next free
  // 'StartUniqueSerialNumber' =  80032 DoD 	second batch	 30,000 keys
  // **Next free 'StartUniqueSerialNumber' = 110081
  // OLD KEY		... NOTE: this CZ first batch for USA (code 0) of 275,000
  // may
  // also be distributed in Canada
  // OLD KEY		... i.e. they should ideally have had code 11, but we
  // didn't
  // want to re-issue them. OLD KEY		ConditionZero	first batch
  // 275,000 keys	**Next free 'StartUniqueSerialNumber' = 275000 NEW KEY
  // These were moved to region 11 as suggested above (part of first batch of
  // 379,000)
  eUSA = 0,

  // DoD 	first batch		  7,500	keys	**Next free
  // 'StartUniqueSerialNumber' = 7500
  eAustralia = 1,

  // DoD 	first batch		 15,000	keys	**Next free
  // 'StartUniqueSerialNumber' = 15000
  eKorea = 2,

  // DoD 	first batch		 10,000	keys	**Next free
  // 'StartUniqueSerialNumber' = 10000
  eTaiwan = 3,

  // DoD 	first batch		  5,000	keys	**Next free
  // 'StartUniqueSerialNumber' = 5000
  eJapan = 4,

  // DoD 	first batch		 25,000 keys	**Next free
  // 'StartUniqueSerialNumber' = 25003
  // ConditionZero	first batch		 99,000 keys	**Next free
  // 'StartUniqueSerialNumber' = 99000
  eUK = 5,

  // DoD 	first batch		 15,000 keys	**Next free
  // 'StartUniqueSerialNumber' = 15002
  // ConditionZero	first batch		 77,000 keys	**Next free
  // 'StartUniqueSerialNumber' = 77000
  eFrance = 6,

  // DoD 	first batch		  3,000 keys	**Next free
  // 'StartUniqueSerialNumber' = 3000
  // DoD 	second batch	  5,000 keys	**Next free
  // 'StartUniqueSerialNumber'
  // = 8002
  // ConditionZero	first batch		132,000 keys	**Next free
  // 'StartUniqueSerialNumber' = 132000
  eGermany = 7,

  // DoD 	first batch		  3,000 keys	**Next free
  // 'StartUniqueSerialNumber' = 3000
  // ConditionZero	first batch		 27,500 keys	**Next free
  // 'StartUniqueSerialNumber' = 27500
  eSpain = 8,

  // DoD 	first batch		  3,000 keys	**Next free
  // 'StartUniqueSerialNumber' = 3000
  // ConditionZero	first batch		 44,000 keys	**Next free
  // 'StartUniqueSerialNumber' = 44000
  eItaly = 9,

  // DoD 	first batch		 65,000 keys	**Next free
  // 'StartUniqueSerialNumber' = 65039
  // DoD 	second batch	 20,000 keys	**Next free
  // 'StartUniqueSerialNumber'
  // = 85058
  eChina = 10,
  ...
  // first batch		 15,000 keys	**Next free 'StartUniqueSerialNumber'
  // =
  // 15000
  eCyberCafeEurope = 12,
  ...
  // valid: OLD KEY	HL2 	first batch  250,000 keys
  ...
  // DoD 	first batch		     20 keys	**Next free
  // 'StartUniqueSerialNumber' = 20 DoD 	second batch	    150 keys
  // **Next free 'StartUniqueSerialNumber' = 170 DoD 	second batch 500 keys
  // **Next free 'StartUniqueSerialNumber' = 670 ConditionZero	first batch
  // 200 keys	**Next free 'StartUniqueSerialNumber' = 200 CyberCafeBundle
  // first batch		    100 keys	**Next free 'StartUniqueSerialNumber'
  // =
  // 100
  eInternal = 255
};
