...
// The current network protocol version.  Changing this makes clients and
// servers incompatible
...
// For backward compatibility of demo files (before the special DSP was shipped
// to public)
...
// For backward compatibility of demo files (post Halloween sound flag extra
// bit)
...
// For backward compatibility of demo files (create string tables compression
// flag)
