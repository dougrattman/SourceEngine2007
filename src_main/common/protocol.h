...
// the name is a remnant...
#define SERVER_STARTUP_DATA_TABLENAME "server_query_info"
...
#define PROTOCOL_AUTHCERTIFICATE 0x01
// Connection from client is using hashed CD key because WON comm.
// channel was unreachable
#define PROTOCOL_HASHEDCDKEY 0x02
