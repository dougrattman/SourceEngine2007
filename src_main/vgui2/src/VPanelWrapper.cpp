...
class VPanelWrapper : public vgui::IPanel {
 public:
  ...
  virtual void Solve(VPANEL vguiPanel) { ((VPanel *)vguiPanel)->Solve(); }
  ...
  virtual void Think(VPANEL vguiPanel) { Client(vguiPanel)->Think(); }
  ...
  virtual void Repaint(VPANEL vguiPanel) { Client(vguiPanel)->Repaint(); }
