...
class CSoundEmitterSystemBase : public ISoundEmitterSystemBase {
 ...
 public:
  ...
  virtual void UpdateSoundParameters(const char *soundname,
                                     const CSoundParametersInternal &params);
  ...
  virtual bool GetParametersForSoundEx(const char *soundname,
 ...
 private:
  void AddSoundsFromFile(const char *filename, bool bPreload,
                         bool bIsOverride = false);

  bool InitSoundInternalParameters(const char *soundname, KeyValues *kv,
  ...
  void EnsureAvailableSlotsForGender(SoundFile *pSoundnames, int c,
                                     gender_t gender);
  void AddSoundName(CSoundParametersInternal &params, char const *wavename,
                    gender_t gender);

  CUtlDict<gender_t, uint8_t> m_ActorGenders;
