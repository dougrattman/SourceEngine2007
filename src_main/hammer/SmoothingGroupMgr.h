...
class ISmoothingGroupMgr {
 public:
  virtual void AddFaceToGroup(SmoothingGroupHandle_t hGroup,
                              CMapFace *pFace) = 0;
  virtual void RemoveFaceFromGroup(SmoothingGroupHandle_t hGroup,
                                   CMapFace *pFace) = 0;

  virtual void SetGroupSmoothingAngle(SmoothingGroupHandle_t hGroup,
                                      float flAngle) = 0;
  ...
  virtual CMapFace *GetFaceFromGroup(SmoothingGroupHandle_t hGroup,
                                     int iFace) = 0;

  virtual ChunkFileResult_t SaveVMF(CChunkFile *pFile,
                                    CSaveInfo *pSaveInfo) = 0;
