...
//			Placeholder textures are used for textures that are
//referenced in 			the map file but not found in storage.
//
//=============================================================================//
...
//				pointer is NULL, no data is copied, only the data size
//is returned.
// Output : Returns a the size of the RGB image in bytes.
//-----------------------------------------------------------------------------
int CDummyTexture::GetImageDataRGB(void *pImageRGB) { return (0); }
...
//-----------------------------------------------------------------------------
int CDummyTexture::GetImageDataRGBA(void *pImageRGBA) { return (0); }
...
//			dwFlags -
//-----------------------------------------------------------------------------
void CDummyTexture::Draw(CDC *pDC, RECT &rect, int iFontHeight, int iIconHeight,
...
//-----------------------------------------------------------------------------
bool CDummyTexture::Load(void) { return (true); }
