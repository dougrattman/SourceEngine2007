...
class CVisGroup {
 public:
  ...
  inline void SetColor(unsigned char red, unsigned char green,
                       unsigned char blue);
  ...
  static ChunkFileResult_t LoadVisGroupCallback(CChunkFile *pFile,
                                                LoadVisGroupData_t *pLoadData);
  static ChunkFileResult_t LoadVisGroupsCallback(CChunkFile *pFile,
                                                 CMapDoc *pDoc);
...
//-----------------------------------------------------------------------------
inline void CVisGroup::SetColor(unsigned char red, unsigned char green,
                                unsigned char blue) {
  m_rgbColor.r = red;
  m_rgbColor.g = green;
  m_rgbColor.b = blue;
