...
// Accumulated filtered time on machine ( i.e., host_framerate can alter
// host_time )
...
// Normally, this is off, and it keeps the VCR file size smaller, but it can
// help to turn it on when tracking down out-of-sync errors, because it verifies
// that more things are the same during playback.
