...
class CGameEventManager : public IGameEventManager2 {
 ...
 public:  // IGameEventManager functions
  enum {
    ...
    CLIENTSTUB,  // this is a serverside stub for a remote client listener (used
                 // by engine only)
 ...
 public:
  ...
  bool AddListener(void *listener, CGameEventDescriptor *descriptor,
                   int nListenerType);
 ...
 protected:
  ...
  CUtlVector<CGameEventCallback *>
      m_Listeners;               // list of all registered listeners
