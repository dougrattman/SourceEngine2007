...
void R_AddDynamicLights(SurfaceHandle_t surfID, msurfacelighting_t *pLighting,
                        const matrix3x4_t &entityToWorld);
void R_BuildLightMap(struct dlight_t *pLights, class ICallQueue *pCallQueue,
...
extern Vector4D blocklights[NUM_BUMP_VECTS + 1]
