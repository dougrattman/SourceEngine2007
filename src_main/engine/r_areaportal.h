...
// view space (-1,-1) - (1,1)
// BUGBUG: NOTE!!!: These are left->right, and bottom->top, so a full rect is
...
enum {
  ...
  FRUSTUM_CLIP_MASK = FRUSTUM_CLIP_RIGHT | FRUSTUM_CLIP_LEFT |
                      FRUSTUM_CLIP_TOP | FRUSTUM_CLIP_BOTTOM,
