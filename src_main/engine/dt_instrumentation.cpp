...
class CDTIProp {
 public:
  CDTIProp() { m_nDecodes = m_nDataBits = m_nIndexBits = 0; }
...
class CDTIRecvTable {
 public:
  CDTIRecvTable() { m_bSawAction = false; }
...
void _DTI_HookDeltaBits(CRecvDecoder *pDecoder, int iProp, int nDataBits,
                        int nIndexBits) {
