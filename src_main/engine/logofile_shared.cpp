...
CLogoFilename::CLogoFilename(CRC32_t value, bool bInDownloadsDirectory) {
  ...
  if (bInDownloadsDirectory) {
    Q_snprintf(m_Filename, sizeof(m_Filename),
               "materials/decals/downloads/%s.vtf", hex);
  } else {
...
const char *SVC_LogoFileData::ToString() const { return "SVC_LogoFileData"; }
...
const char *CLC_LogoFileData::ToString() const { return "CLC_LogoFileData"; }
...
const char *SVC_LogoFileCRC::ToString() const { return "LogoFileCRC"; }
...
const char *CLC_LogoFileRequest::ToString() const { return "LogoFileRequest"; }
...
const char *SVC_LogoFileRequest::ToString() const { return "LogoFileRequest"; }
