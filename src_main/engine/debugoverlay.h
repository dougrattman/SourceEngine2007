...
void AddEntityTextOverlay(int ent_index, int line_offset, float flDuration,
                          int r, int g, int b, int a, const char* text);
void AddBoxOverlay(const Vector& origin, const Vector& mins, const Vector& max,
...
void AddTextOverlay(const Vector& origin, int line_offset, float flDuration,
                    const char* text);
void AddTextOverlay(const Vector& origin, int line_offset, float flDuration,
