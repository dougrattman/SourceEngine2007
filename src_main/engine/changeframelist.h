...
//
// It provides fast access to a list of properties that changed within a certain
// frame range.
//
...
// Call to initialize. Pass in the number of properties this CChangeFrameList
// will hold. All properties will be initialized to iCurFrame.
