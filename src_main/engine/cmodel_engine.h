...
// int CM_TransformedBoxContents( const Vector& pos, const Vector& mins, const
// Vector& maxs, int headnode, const Vector& origin, const QAngle& angles );
...
bool CM_HeadnodeVisible(int headnode, const uint8_t *visbits, int vissize);
...
class CFastPointLeafNum {
 public:
  CFastPointLeafNum()
      : m_iCachedLeaf{0},
        m_vCachedPos{0.0f, 0.0f, 0.0f},
        m_flDistToExitLeafSqr{-1.0f} {}
