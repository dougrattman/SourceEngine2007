...
class CDemoSmootherPanel : public vgui::Frame {
 ...
 protected:
  ...
  void DrawSmoothingSample(bool original, bool processed, int samplenumber,
                           demosmoothing_t *sample, demosmoothing_t *next);
  ...
  bool GetInterpolatedOriginAndAngles(bool readonly, Vector &origin,
                                      QAngle &angles);
  ...
  void AddSamplePoints(bool usetarget, bool includeboundaries,
                       CUtlVector<demosmoothing_t *> &points, int start,
                       int end);
  demosmoothing_t *GetBoundedSample(CUtlVector<demosmoothing_t *> &points,
                                    int sample);
  void FindSpanningPoints(int tick, CUtlVector<demosmoothing_t *> &points,
                          int &prev, int &next);
