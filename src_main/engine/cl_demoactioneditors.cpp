...
CBaseActionEditDialog::CBaseActionEditDialog(CDemoEditorPanel *parent,
  ...
  if (m_bNewAction) {
    SetTitle(
        va("New %s Action", CBaseDemoAction::NameForType(action->GetType())),
        true);
  } else {
    SetTitle(
        va("Edit %s Action", CBaseDemoAction::NameForType(action->GetType())),
        true);
  }
  ...
  m_pStartType =
      new vgui::ComboBox(this, "ActionStartType", (int)NUM_TIMING_TYPES, false);

  for (int i = 0; i < (int)NUM_TIMING_TYPES; i++) {
    m_pStartType->AddItem(
        CBaseDemoAction::NameForTimingType((DEMOACTIONTIMINGTYPE)i), NULL);
  }
...
bool CBaseActionEditDialog::OnSaveChanges(void) {
  ...
  DEMOACTIONTIMINGTYPE timingType =
      CBaseDemoAction::TimingTypeForName(starttype);
...
//			newaction -
//-----------------------------------------------------------------------------
CBaseActionWithTargetDialog::CBaseActionWithTargetDialog(
    CDemoEditorPanel *parent, CBaseDemoAction *action, bool newaction)
...
class CBaseActionSkipAheadDialog : public CBaseActionEditDialog {
 ...
 public:
  CBaseActionSkipAheadDialog(CDemoEditorPanel *parent, CBaseDemoAction *action,
                             bool newaction);
...
CBaseActionSkipAheadDialog::CBaseActionSkipAheadDialog(CDemoEditorPanel *parent,
                                                       CBaseDemoAction *action,
                                                       bool newaction)
    : CBaseActionEditDialog(parent, action, newaction) {
...
class CBaseActionStopPlaybackDialog : public CBaseActionEditDialog {
 ...
 public:
  CBaseActionStopPlaybackDialog(CDemoEditorPanel *parent,
...
class CBaseActionScreenFadeStartDialog : public CBaseActionEditDialog {
 ...
 public:
  CBaseActionScreenFadeStartDialog(CDemoEditorPanel *parent,
                                   CBaseDemoAction *action, bool newaction)
      : BaseClass(parent, action, newaction) {
    ...
    m_pFFADE_OUT =
        new vgui::CheckButton(this, "ScreenFadeFFADE_OUT", "Fade out");
    m_pFFADE_MODULATE =
        new vgui::CheckButton(this, "ScreenFadeFFADE_MODULATE", "Modulate");
    m_pFFADE_STAYOUT =
        new vgui::CheckButton(this, "ScreenFadeFFADE_STAYOUT", "Stay out");
    m_pFFADE_PURGE =
        new vgui::CheckButton(this, "ScreenFadeFFADE_Purge", "Purge");
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CBaseActionScreenFadeStartDialog::CheckFlagDifference(
    vgui::CheckButton *check, bool oldval, int flag) {
  bool bret = false;
...
DECLARE_DEMOACTIONEDIT(DEMO_ACTION_SCREENFADE_START,
...
class CBaseActionTextMessageStartDialog : public CBaseActionEditDialog {
 ...
 public:
  CBaseActionTextMessageStartDialog(CDemoEditorPanel *parent,
                                    CBaseDemoAction *action, bool newaction)
      : BaseClass(parent, action, newaction) {
 ...
 private:
  ...
  bool SaveDifferingColor(vgui::TextEntry *control, uint8_t *r, uint8_t *g,
                          uint8_t *b, uint8_t *a);
...
CBaseActionTextMessageStartDialog::EffectType
...
int CBaseActionTextMessageStartDialog::EffectTypeForName(char const *name) {
  ...
  int i;
  for (i = 0; i < c; i++) {
    if (!Q_strcasecmp(s_EffectTypes[i].name, name)) return i;
  }
  Assert(0);
  return 0;
}
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CBaseActionTextMessageStartDialog::SaveDifferingFloat(
    vgui::TextEntry *control, float *curval) {
  bool bret = false;
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CBaseActionTextMessageStartDialog::SaveDifferingInt(
    vgui::TextEntry *control, int *curval) {
  bool bret = false;
...
bool CBaseActionTextMessageStartDialog::SaveDifferingColor(
    vgui::TextEntry *control, uint8_t *r, uint8_t *g, uint8_t *b, uint8_t *a) {
  bool bret = false;
...
DECLARE_DEMOACTIONEDIT(DEMO_ACTION_TEXTMESSAGE_START,
...
class CBaseActionPlayCommandsDialog : public CBaseActionEditDialog {
 ...
 public:
  CBaseActionPlayCommandsDialog(CDemoEditorPanel *parent,
                                CBaseDemoAction *action, bool newaction);
...
class CBaseActionCDTrackStartDialog : public CBaseActionEditDialog {
 ...
 public:
  CBaseActionCDTrackStartDialog(CDemoEditorPanel *parent,
                                CBaseDemoAction *action, bool newaction);
...
DECLARE_DEMOACTIONEDIT(DEMO_ACTION_PLAYCDTRACK_START,
...
class CBaseActionPlaySoundStartDialog : public CBaseActionEditDialog {
 ...
 public:
  CBaseActionPlaySoundStartDialog(CDemoEditorPanel *parent,
                                  CBaseDemoAction *action, bool newaction);
...
DECLARE_DEMOACTIONEDIT(DEMO_ACTION_PLAYSOUND_START,
...
class CBaseActionWithStopTimeDialog : public CBaseActionEditDialog {
 ...
 public:
  CBaseActionWithStopTimeDialog(CDemoEditorPanel *parent,
                                CBaseDemoAction *action, bool newaction);
...
// Purpose:
//-----------------------------------------------------------------------------
class CBaseActionChangePlaybackRateDialog
    : public CBaseActionWithStopTimeDialog {
  typedef CBaseActionWithStopTimeDialog BaseClass;

 public:
  CBaseActionChangePlaybackRateDialog(CDemoEditorPanel *parent,
                                      CBaseDemoAction *action, bool newaction);
...
DECLARE_DEMOACTIONEDIT(DEMO_ACTION_CHANGEPLAYBACKRATE,
...
class CBaseActionPauseDialog : public CBaseActionEditDialog {
 ...
 public:
  CBaseActionPauseDialog(CDemoEditorPanel *parent, CBaseDemoAction *action,
                         bool newaction);
...
CBaseActionPauseDialog::CBaseActionPauseDialog(CDemoEditorPanel *parent,
                                               CBaseDemoAction *action,
                                               bool newaction)
    : BaseClass(parent, action, newaction) {
...
// Fonts
/*
                // if a font fails to load then the subsequent fonts will
   replace "Default" "DefaultUnderline" "DefaultSmall" "DefaultVerySmall"
                "DefaultLarge"
                "Marlett"
                "Trebuchet24"
                "Trebuchet20"
...
class CBaseActionZoomDialog : public CBaseActionEditDialog {
 ...
 public:
  CBaseActionZoomDialog(CDemoEditorPanel *parent, CBaseDemoAction *action,
                        bool newaction);
