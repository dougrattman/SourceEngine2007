...
void DTI_HookDeltaBits(CRecvDecoder *pDecoder, int iProp, int nDataBits,
                       int nIndexBits);
...
inline void DTI_HookDeltaBits(CRecvDecoder *pDecoder, int iProp, int nDataBits,
                              int nIndexBits) {
  if (g_bDTIEnabled) {
    extern void _DTI_HookDeltaBits(CRecvDecoder * pDecoder, int iProp,
                                   int nDataBits, int nIndexBits);
