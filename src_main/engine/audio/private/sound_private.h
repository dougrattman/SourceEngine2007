...
// resync the sample-timing adjustment clock (for scheduling a group of waves
// with precise timing - e.g. machine gun sounds)
...
extern void Mix8MonoWavtype(channel_t *pChannel, portable_samplepair_t *pOutput,
                            int *volume, uint8_t *pData, int inputOffset,
                            fixedint rateScaleFix, int outCount);
extern void Mix8StereoWavtype(channel_t *pChannel,
                              portable_samplepair_t *pOutput, int *volume,
                              uint8_t *pData, int inputOffset,
                              fixedint rateScaleFix, int outCount);
extern void Mix16MonoWavtype(channel_t *pChannel,
                             portable_samplepair_t *pOutput, int *volume,
                             short *pData, int inputOffset,
                             fixedint rateScaleFix, int outCount);
extern void Mix16StereoWavtype(channel_t *pChannel,
                               portable_samplepair_t *pOutput, int *volume,
                               short *pData, int inputOffset,
                               fixedint rateScaleFix, int outCount);

extern void SND_MoveMouth8(channel_t *pChannel, CAudioSource *pSource,
                           int count);
