...
//! This function is implemented in voice.cpp. Gives 16-bit signed mono samples
//! to the mixer. \return Number of samples actually gotten.
...
// This is called when an audio source is deleted by the sound engine. The voice
// could should detach whatever it needs to in order to free up the specified
// channel.
