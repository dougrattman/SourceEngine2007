...
struct DemoCommandQueue {
  DemoCommandQueue() : tick{0}, filepos{0} {}
  int tick;
  democmdinfo_t info;
  int filepos;
};
...
class CDemoPlayer : public IDemoPlayer {
 ...
 public:  // other public functions
  ...
  void InterpolateDemoCommand(int targettick, DemoCommandQueue &prev,
...
class CDemoRecorder : public IDemoRecorder {
 public:
  ...
  void RecordServerClasses(
      ServerClass
          *pClasses);  // packet finished, write all recorded stuff to file
