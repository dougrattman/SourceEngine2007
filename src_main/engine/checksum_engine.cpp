...
// single uint8_t block CRC based on current network sequence number.
// Input  : *base -
//			length -
//			sequence -
// Output : uint8_t COM_BlockSequenceCRCByte
//-----------------------------------------------------------------------------
uint8_t COM_BlockSequenceCRCByte(uint8_t *base, int length, int sequence) {
  ...
  // Use up to the first 60 bytes of data and a 4 uint8_t value from the
...
value should be initialized with CRC_Init
 ==================
 */
