...
// Purpose: Constructor
//-----------------------------------------------------------------------------
EditablePanel2Demo::EditablePanel2Demo(Panel *parent, const char *name)
  ...
  */
  ...
  // "InternetSpeed" and this panel name happens to be the very next panel in
  // the list. Its 'ControlName' tells us it is a ComboBox. Hitting the 'S'
  // hotkey will trigger the combo box to gain focus. Note that the combo box
  // does not currently have any items within it.
  ...
  // combo box.
  m_pInternetSpeed =
      new ComboBox(this, "InternetSpeed", std::size(g_Speeds), false);
