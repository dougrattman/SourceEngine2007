...
int CBugReporter::GetNameCount() { return GetDisplayNameCount(); }

char const *CBugReporter::GetName(int index) { return GetDisplayName(index); }
...
char const *CBugReporter::GetRepositoryURL(void) { return m_BugRootDirectory; }
...
void CBugReporter::StartNewBugReport() {
  ...
  do {
    ...
    Q_snprintf(m_CurrentBugDirectory, sizeof(m_CurrentBugDirectory),
               ...
               t.tm_sec, m_BugStrings.String(m_UserName));
...
bool CBugReporter::SymbolLessThan(const CUtlSymbol &sym1,
