...
class CPhysCollisionEntry {
 ...
 protected:
  void DumpCollideFileName(const char *pName, int modelIndex,
...
class CPhysCollisionEntryStaticMesh : public CPhysCollisionEntry {
 public:
  CPhysCollisionEntryStaticMesh(CPhysCollide *pCollide,
...
class CTextBuffer {
 public:
  ...
  void WriteFloatArrayKey(const char *pKeyName, const float *outputData,
                          int count);
