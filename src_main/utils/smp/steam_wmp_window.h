...
#ifndef STEAM_WMP_WINDOW_H_
#define STEAM_WMP_WINDOW_H_

#include "atl_headers.h"

#include <oledlg.h>
// if this file isn't found, set your path to include the wmp sdk include
...
class SteamWMPWindow
 ...
 public:
  ...
  LRESULT OnErase(UINT /* uMsg */, WPARAM /* wParam */, LPARAM /* lParam */,
                  BOOL& bHandled);
  ...
  LRESULT OnClick(UINT /* uMsg */, WPARAM /* wParam */, LPARAM /* lParam */,
                  BOOL& /* lResult */);
  LRESULT OnLeftDoubleClick(UINT /* uMsg */, WPARAM /* wParam */,
                            LPARAM /* lParam */, BOOL& /* lResult */);
