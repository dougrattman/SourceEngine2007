...
void GetHourMinuteSeconds(int nInputSeconds, int &nHours, int &nMinutes,
                          int &nSeconds) {}
...
==============
*/
char *COM_Parse(char *data) { return (char *)ParseFile(data, com_token, NULL); }
...
int CmdLib_GetNumBasePaths(void) { return g_NumBasePaths; }
