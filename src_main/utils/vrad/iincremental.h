...
class IIncremental {
 ...
 public:
  ...
  virtual bool Init(char const *pBSPFilename,
                    char const *pIncrementalFilename) = 0;
  ...
  // Called when it's done applying light from the specified light to the
  // specified face.
  virtual void FinishFace(IncrementalLightID lightID, int iFace,
                          int iThread) = 0;
